...
function SendEmail($body, $fromName, $subject, $to, $cc, $bcc, $tipoCuerpo = "T", $tipoRegistroAsociado = NULL,
									 $idRegistroAsociado = -1, $direccionOrigen = NULL) {
	global $conn;
	...
	$sql =
		"INSERT INTO comunes.cee_emailaenviar (ee_direccionesdestino, ee_direccionorigen, ee_motivo, ee_fechamensaje,
