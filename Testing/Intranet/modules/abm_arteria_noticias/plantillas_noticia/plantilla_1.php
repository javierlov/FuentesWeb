<?
$img = "/modules/abm_arteria_noticias/images/imagen_plantilla_1.jpg";
$jsImagen = "";
...
?>
<tr>
	<td width="576" valign="top" rowspan="2">
		<table border="0" cellpadding="0" cellspacing="0" width="100%" height="350">
			...
			<tr>
				...
				<td class="CuerpoArticulo" valign="top">
					<div id="imgder" style="margin-right:10px;"><a href="#" onClick="mostrarImagen(0);"><img align="right" border="0" src="<?= $img?>" style="margin-bottom:8px; margin-left:8px;"></a></div>
					<p style="margin-left: 10px; margin-right: 10px"><?= $nota?></p>
				</td>
			</tr>
		</table>
	</td>
