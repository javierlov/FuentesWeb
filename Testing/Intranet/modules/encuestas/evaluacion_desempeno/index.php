...
<input id="ValidarCompetenciasConduccion" name="ValidarCompetenciasConduccion" type="hidden">
	<table bgcolor="#FFFFFF" align="center" width="755" border="2" bordercolor="#808080" id="table1" style="border-style: solid; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<tr>
			<td>
				<table style="padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" bgcolor="#FFFFFF" align="center" cellspacing="0" width="754">
					<tr>
						<td colspan="3" height="51">
							<table border="0" width="100%" cellspacing="0">
								<tr>
									<td style="border-bottom-style: solid; border-bottom-width: 1px; padding-left: 4px; padding-right: 4px"><p style="margin-top: 0; margin-bottom: 0"><b><font face="Verdana" style="font-size: 8pt">SISTEMA DE EVALUACIÓN DEL DESEMPEÑO</font></b></td>
									<td width="115" style="border-bottom-style: solid; border-bottom-width: 1px; padding-left: 4px; padding-right: 4px"><img border="0" src="images/logoART.jpg" width="115" height="26"></td>
								</tr>
								<tr>
						...
						<td width="377" height="50" valign="top" rowspan="2">
							<table border="0" id="table3" bgcolor="#FFFFFF" cellspacing="0">
								<tr>
									...
									<td><font face="Verdana" style="font-size: 8pt" color="#336699">&nbsp;<?= GetUserName($_SESSION["identidad"]) ?></font></td>
								</tr>
							</table>
						</td>
						<td align="left" width="293" height="21" valign="top">
							...
							<table bgcolor="#FFFFFF" border="0" cellspacing="0" id="tableUsuariosAEvaluar" name="tableUsuariosAEvaluar" width="293">
								<tr>
									...
									<td bgcolor="#C0C0C0" bordercolor="#808080" style="border-bottom-style: solid; border-bottom-width: 1px; border-right-style: solid; border-right-width: 1px; border-top-style: solid; border-top-width: 1px; padding-left: 4px; padding-right: 4px;"><select id="UsuarioAEvaluar" name="UsuarioAEvaluar" size="1" validar="true" title="Usuario a evaluar" style="color: #808080; font-family: Verdana; font-size: 8pt; font-weight: bold; border: 1px solid #808080; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px;" onChange="cambiarUsuarioAEvaluar(document.getElementById('UsuarioAEvaluar').value, document.getElementById('Ano').value)"></select></td>
								</tr>
							</table>
						</td>
...
?>
							<img alt="Cambiar Identidad" border="0" src="images/cambiar_identidad.png" style="cursor:pointer" onClick="cambiarIdentidad()" /><br/>
<?
}
?>
							<img alt="Ver Resultados" border="0" src="images/resultados.png" style="cursor:pointer" onClick="window.location.href='/modules/encuestas/evaluacion_desempeno/resultados/'" />&nbsp;&nbsp;
							<img alt="Imprimir evaluación" border="0" src="images/imprimir.jpg" style="cursor:pointer" onClick="imprimirEvaluacion()" />
						</td>
					</tr>
					<tr>
						<td align="left" width="293" height="21" valign="top"><p align="center"><div face="Verdana" id="divPeriodo" name="divPeriodo" style="font-size: 8pt">Período: ---</div></td>
						<td align="left" width="86" height="21" valign="top">&nbsp;</td>
					</tr>
					<tr>
						<td width="377" height="67">
							<table border="0" id="table6" cellspacing="0" width="292">
								<tr>
									<td style="padding-left: 4px; padding-right: 4px" rowspan="5" width="7">&nbsp;</td>
									<td colspan="2" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px" bordercolor="#808080" bgcolor="#6E96BC"><span style="font-weight: 700"><font face="Verdana" color="#FFFFFF" size="1">DATOS EVALUADOR</font></span></td>
								</tr>
								<tr>
									<td style="border-bottom:1px dotted #CCCCCC; padding-left: 4px; padding-right: 4px" width="127"><span style="font-weight: 700"><font face="Verdana" style="font-size: 8pt" color="#808080">Nombre</font></span><font face="Verdana" style="font-size: 8pt; font-weight: 700" color="#808080"> y Apellido:</font></td>
									<td style="border-bottom:1px dotted #CCCCCC; padding-left: 4px; padding-right: 4px" width="134"><span face="Verdana" id="NombreEvaluador" name="NombreEvaluador" style="font-size: 8pt">&nbsp;</span></td>
								</tr>
								<tr>
									<td style="border-bottom:1px dotted #CCCCCC; padding-left: 4px; padding-right: 4px" width="127"><span style="font-weight: 700"><font face="Verdana" style="font-size: 8pt" color="#808080">Puesto</font></span><font face="Verdana" style="font-size: 8pt; font-weight: 700" color="#808080">:</font></td>
									<td style="border-bottom:1px dotted #CCCCCC; padding-left: 4px; padding-right: 4px" width="134"><span face="Verdana" id="PuestoEvaluador" name="PuestoEvaluador" style="font-size: 8pt">&nbsp;</span></td>
								</tr>
								<tr>
									<td style="border-bottom:1px dotted #CCCCCC; padding-left: 4px; padding-right: 4px" width="127"><font face="Verdana" style="font-size: 8pt; font-weight: 700" color="#808080">Área/Sector:</font></td>
									<td style="border-bottom:1px dotted #CCCCCC; padding-left: 4px; padding-right: 4px" width="134"><span face="Verdana" id="SectorEvaluador" name="SectorEvaluador" style="font-size: 8pt">&nbsp;</span></td>
								</tr>
								<tr>
									<td style="border-bottom:1px dotted #CCCCCC; padding-left: 4px; padding-right: 4px" width="127"><b><font face="Verdana" style="font-size: 8pt" color="#808080">Gerencia:</font></b></td>
									<td style="border-bottom:1px dotted #CCCCCC; padding-left: 4px; padding-right: 4px" width="134"><span face="Verdana" id="GerenciaEvaluador" name="GerenciaEvaluador" style="font-size: 8pt">&nbsp;</span></td>
								</tr>
							</table>
						</td>
						<td align="left" width="375" valign="top" colspan="2">
							<table border="0" id="table7" cellspacing="0">
								<tr>
									<td colspan="2" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px" bordercolor="#808080" bgcolor="#6E96BC"><span style="font-weight: 700"><font face="Verdana" color="#FFFFFF" size="1">DATOS EVALUADO</font></span></td>
								</tr>
								<tr>
									<td style="border-bottom:1px dotted #C0C0C0; padding-left: 4px; padding-right: 4px"><span style="font-weight: 700"><font face="Verdana" style="font-size: 8pt" color="#808080">Nombre</font></span><font face="Verdana" style="font-size: 8pt; font-weight: 700" color="#808080"> y Apellido:</font></td>
									<td style="border-bottom:1px dotted #C0C0C0; padding-left: 4px; padding-right: 4px"><span face="Verdana" id="NombreEvaluado" name="NombreEvaluado" style="font-size: 8pt">&nbsp;</span></td>
								</tr>
								<tr>
									<td style="border-bottom:1px dotted #C0C0C0; padding-left: 4px; padding-right: 4px"><span style="font-weight: 700"><font face="Verdana" style="font-size: 8pt" color="#808080">Puesto</font></span><font face="Verdana" style="font-size: 8pt; font-weight: 700" color="#808080">:</font></td>
									<td style="border-bottom:1px dotted #C0C0C0; padding-left: 4px; padding-right: 4px"><span face="Verdana" id="PuestoEvaluado" name="PuestoEvaluado" style="font-size: 8pt">&nbsp;</span></td>
								</tr>
								<tr>
									<td style="border-bottom:1px dotted #C0C0C0; padding-left: 4px; padding-right: 4px"><font face="Verdana" style="font-size: 8pt; font-weight: 700" color="#808080">Área/Sector:</font></td>
									<td style="border-bottom:1px dotted #C0C0C0; padding-left: 4px; padding-right: 4px"><span face="Verdana" id="SectorEvaluado" name="SectorEvaluado" style="font-size: 8pt">&nbsp;</span></td>
								</tr>
								<tr>
									<td style="border-bottom:1px dotted #C0C0C0; padding-left: 4px; padding-right: 4px"><b><font face="Verdana" style="font-size: 8pt" color="#808080">Gerencia:</font></b></td>
									<td style="border-bottom:1px dotted #C0C0C0; padding-left: 4px; padding-right: 4px"><font face="Verdana" id="GerenciaEvaluado" name="GerenciaEvaluado" style="font-size: 8pt">&nbsp;</span></td>
								</tr>
							</table>
						</td>
					</tr>
					<tr>
						<td width="752" height="20" colspan="3" style="padding-left: 4px; padding-right: 4px"></td>
					</tr>
				</table>
				<div align="center" class="FormLabelRojo" id="divDatosNoCargados" name="divDatosNoCargados" style="display:none">
					<img border="0" src="images/warning.gif"><br>Su evaluación aún no 
					está disponible.<br>&nbsp;
				</div>
				<div align="center" id="divDatos" name="divDatos">
					<div align="center">
						<table cellspacing="0" cellpadding="0" width="740">
							<tr>
								<td width="752" colspan="2" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px" bgcolor="#AFC2BE" bordercolor="#808080"><p style="margin-left: 6px; margin-top:0; margin-bottom:0"><b><font face="Verdana" style="font-size: 8pt">1.</font><font face="Verdana" style="font-size: 8pt" color="#336699"><a href="#" onClick="mostrarSeccion('divCompetencias');"><span style="text-decoration: none"> [+] </span></a></font><font face="Verdana" style="font-size: 8pt">Competencias</font></b></td>
							</tr>
						</table>
					</div>
					<div id="divCompetencias" name="divCompetencias" style="display:none">
						<table>
							...
							<tr>
								<td width="752"><p style="margin-left: 8px"><font face="Verdana" style="font-size: 8pt; font-weight: 700">EVALUACIÓN DE COMPETENCIAS</font></td>
							</tr>
							<tr>
								<td width="752">
									<div class="Section1">
										<p style="text-indent: 0cm; margin: 0 8px" align="justify"><font face="Verdana" size="2"><span style="font-size: 8pt; font-family: Verdana">Teniendo en cuenta los requerimientos del puesto y los comportamientos observados, indicá para cada competencia el nivel en el que se encuentra el evaluado marcando en la casilla correspondiente. </span></font></p>
										<p style="text-indent: 0cm; margin: 0 8px" align="justify"><span style="font-size: 8pt; font-family: Verdana"><font face="Verdana" color="#336699"><b>Para el nivel A detallá con ejemplos</b></font><font face="Verdana" size="2">.</font></span><p style="text-indent: 0cm; margin: 0 8px" align="justify">&nbsp;
									</div>
								</td>
							</tr>
							<tr>
								<td width="752">
									<div align="center">
										<table border="0" id="table9" cellspacing="1" width="740">
											<tr>
												<td align="center" bgcolor="#6E96BC" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px" bordercolor="#808080" width="267"><font face="Verdana" style="font-weight: 700" color="#FFFFFF" size="1">COMPETENCIAS</font></td>
												...
												<td align="center" bgcolor="#6E96BC" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px" bordercolor="#808080"><font face="Verdana" style="font-weight: 700" color="#FFFFFF" size="1">EJEMPLOS</font></td>
											</tr>
											<tr>
												<td bgcolor="#808080" align="center" width="275"><p style="margin: 0 5px"><font face="Verdana" style="font-size: 8pt" color="#FFFFFF">¿Qué se esperó del evaluado durante <span id="labelAno1">año</span>?</font></td>
												<td bgcolor="#808080" align="center" colspan="5" width="160"><p style="margin: 0 5px"><font face="Verdana" style="font-size: 8pt" color="#FFFFFF">¿Cómo lo hizo durante <span id="labelAno2">año</span>?</font></td>
											...
											<tr>
  											...
  											<td style="border-bottom-style: dotted; border-bottom-width: 1px; padding-left: 4px; padding-right: 4px"><p style="margin-top: 0; margin-bottom: 0"><font face="Verdana"><input id="Orientacion" name="Orientacion" type="radio" value="A"></font></p><p style="margin-top: 0; margin-bottom: 0" align="center"><font face="Verdana" style="font-size: 8pt; cursor:help" onmouseover="myHint.show(1, this)" onmouseout="myHint.hide()">A</font></p></td>
  											<td style="border-bottom-style: dotted; border-bottom-width: 1px; padding-left: 4px; padding-right: 4px" align="center"><p style="margin-top: 0; margin-bottom: 0"><font face="Verdana"><span style="font-size: 8pt"><input id="Orientacion" name="Orientacion" type="radio" value="B"></span></font></p><p style="margin-top: 0; margin-bottom: 0"><font face="Verdana" style="font-size: 8pt; cursor:help" onmouseover="myHint.show(2, this)" onmouseout="myHint.hide()">B</font></td>
  											<td style="border-bottom-style: dotted; border-bottom-width: 1px; padding-left: 4px; padding-right: 4px" align="center"><p style="margin-top: 0; margin-bottom: 0"><font face="Verdana"><span style="font-size: 8pt"><input id="Orientacion" name="Orientacion" type="radio" value="C"></span></font></p><p style="margin-top: 0; margin-bottom: 0"><font face="Verdana" style="font-size: 8pt; cursor:help" onmouseover="myHint.show(3, this)" onmouseout="myHint.hide()">C</font></td>
  											<td style="border-bottom-style: dotted; border-bottom-width: 1px; padding-left: 4px; padding-right: 4px" align="center"><p style="margin-top: 0; margin-bottom: 0"><font face="Verdana"><span style="font-size: 8pt"><input id="Orientacion" name="Orientacion" type="radio" value="D"></span></font></p><p style="margin-top: 0; margin-bottom: 0"><font face="Verdana" style="font-size: 8pt; cursor:help" onmouseover="myHint.show(4, this)" onmouseout="myHint.hide()">D</font></td>
  											<td style="border-bottom-style: dotted; border-bottom-width: 1px; padding-left: 4px; padding-right: 4px" align="center"><p style="margin-top: 0; margin-bottom: 0"><font face="Verdana"><span style="font-size: 8pt"><input id="Orientacion" name="Orientacion" type="radio" value="E"></span></font></p><p style="margin-top: 0; margin-bottom: 0"><font face="Verdana" style="font-size: 8pt; cursor:help" onmouseover="myHint.show(5, this)" onmouseout="myHint.hide()">E</font></td>
  											<td style="border-bottom-style: dotted; border-bottom-width: 1px; padding-left: 4px; padding-right: 4px" width="280"><p style="margin-top: 0; margin-bottom: 0"><textarea cols="45" id="OrientacionObservaciones" name="OrientacionObservaciones" rows="3" style="color: #808080; font-family: Verdana; font-size: 8pt; border: 1px solid #808080; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px;" onKeyUp="resizeTextarea(this)" onMouseUp="resizeTextarea(this)"></textarea></p></td>
  										</tr>
  										<tr>
  											<td style="border-bottom-style: dotted; border-bottom-width: 1px; padding-left: 4px; padding-right: 4px" width="269">
													<table>
  										...
  										<tr>
  											...
  											<td align="center" rowspan="4" valign="top" style="padding-left: 4px; padding-right: 4px">
  												<table border="0" cellpadding="0" cellspacing="1" width="292">
  													...
  													<tr>
  														<td style="padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" width="123"><a href="#" id="btnGuardarObjetivo1" name="btnGuardarObjetivo1" onClick="guardarObjetivo(1)"><img border="0" alt="Guardar Objetivo" src="images/guardar_objetivo.jpg"></a></td>
  														<td style="padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" width="123">&nbsp;</td>
  														<td style="padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" width="104"><p align="right"><a href="#" id="btnModificarObjetivo1" name="btnModificarObjetivo1" onClick="modificarObjetivo(1)"><img border="0" alt="Modificar Objetivos" src="images/modificar_objetivos.jpg" width="27" height="30"></a></td>
  														<td style="padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" width="33"><a href="#" onClick="verHistorico(1)"><img border="0" alt="Histórico" src="images/historico.jpg" width="27" height="30" align="right"></a></td>
  													</tr>
  												</table>
  											</td>
  										</tr>
  										...
  										<tr>
  											...
  											<td align="center" rowspan="4" valign="top" style="padding-left: 4px; padding-right: 4px;">
  												<table border="0" cellpadding="0" cellspacing="1" width="292">
  													...
  													<tr>
  														<td style="padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" width="123"><a href="#" id="btnGuardarObjetivo2" name="btnGuardarObjetivo2" onClick="guardarObjetivo(2)"><img border="0" alt="Guardar Objetivo" src="images/guardar_objetivo.jpg"></a></td>
  														<td style="padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" width="123">&nbsp;</td>
  														<td style="padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" width="104"><p align="right"><a href="#" id="btnModificarObjetivo2" name="btnModificarObjetivo2" onClick="modificarObjetivo(2)"><img border="0" alt="Modificar Objetivos" src="images/modificar_objetivos.jpg" width="27" height="30"></td>
  														<td style="padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" width="33"><a href="#" onClick="verHistorico(2)"><img border="0" alt="Histórico" src="images/historico.jpg" width="27" height="30" align="right"></a></td>
  													</tr>
  												</table>
  											</td>
  										</tr>
  								...
  								<div align="center">
  									<table border="0" cellspacing="0" width="730">
  										<tr>
  											...
  											<td align="center"><a href="#" id="btnInsertarEvento" name="btnInsertarEvento" onClick="insertarEvento()"><img border="0" src="images/eventos.jpg" alt="Insertar Evento" width="27" height="30"></td>
  											<td align="center" width="320">
  												<table border="0" cellspacing="1" width="100%">
  													<tr>
  				...
  				<table>
  					...
  					<tr>
  						<td width="180" height="21"><p style="margin-left: 45px"><img alt="Imprimir evaluación" border="0" src="images/imprimir.jpg" style="cursor:pointer" onClick="imprimirEvaluacion()" /></td>
