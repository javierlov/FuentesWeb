...
if ($_REQUEST["action"] == "M") {		// Muestro el objetivo..
	$sql =
		"SELECT TO_CHAR(NVL(fo_fechamodif, fo_fechaalta), 'DD/MM/YYYY') fechamodif, fo_id_formularioevaluacion, fo_indicador,
					  fo_motivoreemplazo, fo_motivoreemplazootros, fo_objetivo, fo_plazo, fo_resultado, NVL(fo_usumodif, fo_usualta) usumodif
			FROM rrhh.hfo_formularioobjetivo
		 WHERE fo_id = :id";
