...
<script type="text/javascript" src="/modules/encuestas/evaluacion_desempeno/js/abm.js"></script>
<script type="text/javascript" src="/modules/encuestas/evaluacion_desempeno/js/hint_config_abm.js"></script>
<script>
	divWin = null;
	...
	function seleccionarPersona(titulo, nombre, id) {
		...
		myHint.hide();
		divWin.load('iframe', '/modules/encuestas/evaluacion_desempeno/abm_usuarios/seleccionar_persona.php?titulo=' + titulo + '&objNombre=' + nombre + '&objId=' + id, titulo);
		divWin.show();
	}
...
<form action="/modules/encuestas/evaluacion_desempeno/abm_usuarios/procesar_usuario.php" id="formUsuario" method="post" name="formUsuario" target="iframeUsuario" onSubmit="return ValidarForm(formUsuario)">
