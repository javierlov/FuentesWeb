...
var HINTS_CFG = {
	...
	'show_delay' : 40, // a delay between initiating event (mouseover for example) and hint appearing
...
var HINTS_ITEMS = [
	wrap2('Seleccionar evaluado'),
	wrap2('Seleccionar evaluador'),
	wrap2('Seleccionar supervisor'),
	wrap2('Seleccionar notificación 1'),
	wrap2('Seleccionar notificación 2')
];
