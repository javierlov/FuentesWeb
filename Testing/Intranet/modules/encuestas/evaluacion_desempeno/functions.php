<?
function DisableControls($isEvaluado, $isEvaluador, $isSupervisor, $isNotificado, $isFueEvaluado, $isEvaluacionAceptada, $isEvaluacionVigente,
										 $existeEvaluacionAnterior, $otraIdentidad) {
