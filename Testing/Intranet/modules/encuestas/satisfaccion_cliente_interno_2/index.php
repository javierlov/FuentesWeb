...
<h1 style="color:#07367e;">PROGRAMA DE INCENTIVOS <?= ($ano - 1)?><br />ENCUESTA DE SATISFACCIÓN CLIENTE INTERNO</h1>
<?
...
<div id="divPaso1">
	<div style="border:2px #000 solid; margin-bottom:16px; margin-top:8px; padding:4px;">
		Se deberá completar una encuesta por cada sector a evaluar. Aparecerán disponibles los sectores con los cuales se trabajó en el período ene-dic <?= ($ano - 1)?>.<br />
