...
$list->addItem(new ItemList("/index.php?pageid=40&fldr=rrhh/procedimientos/index.php", "Procedimientos", "_self", false, true));
$list->addItem(new ItemList("/index.php?pageid=40&fldr=rrhh/instructivos/index.php", "Instructivos", "_self", false, true));
$list->setCols(1);
