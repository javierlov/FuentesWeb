...
<div align="left">
<?
$list = new ListOfItems(STORAGE_PATH."normas_y_procedimientos/corporativa/manuales/lavado_de_activos/", ":: Manuales");

if ($fechaAceptacion != "")
	$list->addItem(new ItemList("manual_lavado_de_activos.pdf", "Prevención Lavado de Activos", "_blank", true));
else
	$list->addItem(new ItemList("index.php?pageid=40&fldr=corporativa/manuales/prevencion_lavado_activos.php", "Prevención Lavado de Activos", "_self", false, true));
