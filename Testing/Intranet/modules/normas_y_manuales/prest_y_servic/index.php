...
$list->addItem(new ItemList("/index.php?pageid=40&fldr=prest_y_servic/procedimientos/index.php", "Procedimientos", "_self", false, true));
$list->addItem(new ItemList("/index.php?pageid=40&fldr=prest_y_servic/instructivos/index.php", "Instructivos", "_self", false, true));
$list->setCols(1);
