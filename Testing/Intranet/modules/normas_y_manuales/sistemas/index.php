...
<div align="left">
<?
$list = new ListOfItems(STORAGE_PATH."normas_y_manuales/sistemas/", ":: Sistemas");
$list->addItem(new ItemList("/index.php?pageid=40&fldr=sistemas/procedimientos/index.php", "Procedimientos", "_self", false, true));
$list->setCols(1);
