...
$list->addItem(new ItemList("/index.php?pageid=40&fldr=gral/politicas/index.php", "Políticas", "_self", false, true));
...
$list->addItem(new ItemList("/index.php?pageid=40&fldr=gral/codigos/index.php", "Códigos", "_self", false, true));
$list->setCols(1);
