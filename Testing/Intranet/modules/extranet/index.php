...
<script>
	...
	showTitle(true, 'MANTENIMIENTO EXTRANET');
</script>
<link rel="stylesheet" href="http://www.provinciart.com.ar/styles/portada.css" type="text/css" />
<style type="text/css">
	.btnAgregarArticulo {background-image:url(/images/boton_agregar_articulo.jpg); border:0; cursor:pointer; height:15px; width:135px;}
	#btnAplicarCambios {background-image:url(/images/boton_aplicar_cambios.jpg); border:0; cursor:pointer; height:15px; margin-left:24px; width:120px;}
	.btnEnviar {background-image:url(/images/boton_enviar.jpg); border:0; cursor:pointer; height:15px; width:50px;}
	.btnGuardar {background-image:url(/images/boton_guardar.jpg); border:0; cursor:pointer; height:15px; margin-top:16px; width:73px;}
	.btnRecuperar {background-image:url(/images/boton_recuperar.jpg); border:0; cursor:pointer; height:15px; margin-left:24px; width:81px;}
