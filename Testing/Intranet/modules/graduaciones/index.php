...
function getImage($id) {
	...
	if ($img == "")
		$img = base64_encode(DATA_CELEBRACIONES_PATH."default_image_graduaciones.jpg");
...
function getLink($num) {
	...
	if ($pagina == $num)
		...
		echo '<a href="/index.php?pageid=41&pagina='.$num.'" style="color:#ffffff; margin-left:4px; text-decoration:none;">'.$num.'</a>';
}
...
<div style="margin-left:25px; margin-top:24px;">
	<div style="float:left; width:520px;">
		...
		<form action="/functions/save_comment.php" id="formComentario1" method="post" name="formComentario1" target="iframeComentario" onSubmit="return ValidarForm(formComentario1)">
			...
			<input id="idmodulo" name="idmodulo" type="hidden" value="41" />
			...
			<div align="right" style="margin-top:16px;">
				<input class="BotonBlanco" type="button" value="VER COMENTARIOS" onClick="verComentarios(41, <?= $row["NP_ID"]?>)">
