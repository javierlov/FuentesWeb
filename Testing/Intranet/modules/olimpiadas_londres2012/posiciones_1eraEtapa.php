	...
	<head>
		...
		<script>
			function verComentarios(votado, valor) {
				...
				divWin.load('iframe', '/modules/olimpiadas_londres2012/ver_comentarios.php?fase=1&votado=' + votado + '&valor=' + valor, '*');
				divWin.show();
			}
		</script>
	</head>
...
<table cellpadding="0" width="738" cellspacing="0" align="center">
	...
	<tr>
		<td align="center">
			<iframe frameborder="0" src="/modules/olimpiadas_londres2012/tabla_posiciones.php?v=E" style="height:132px; width:524px;"></iframe>
		</td>
	</tr>
	<tr>
		<td height="25px"></td>
	...
	<tr>
		<td align="center">
			<iframe frameborder="0" src="/modules/olimpiadas_londres2012/tabla_posiciones.php?v=S" style="height:128px; width:524px;"></iframe>
		</td>
	</tr>
	<tr>
		<td height="25px"></td>
	...
	<tr>
		<td align="center">
			<iframe frameborder="0" src="/modules/olimpiadas_londres2012/tabla_posiciones.php?v=I" style="height:128px; width:524px;"></iframe>
		</td>
	</tr>
	<tr>
		<td height="25px"></td>
	...
	<tr>
		<td align="center">
			<iframe frameborder="0" src="/modules/olimpiadas_londres2012/tabla_posiciones.php?v=O" style="height:128px; width:524px;"></iframe>
		</td>
	</tr>
	<tr>
		<td height="25px"></td>
	...
	<tr>
		<td align="center">
			<iframe frameborder="0" src="/modules/olimpiadas_londres2012/tabla_posiciones.php?v=N" style="height:128px; width:524px;"></iframe>
		</td>
	</tr>
	<tr>
		<td height="25px"></td>
