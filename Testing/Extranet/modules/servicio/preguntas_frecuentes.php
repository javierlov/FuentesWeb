		...
		<table>
			<tr>
				<td>
					...
					<p>- Cuando se ingresan las remuneraciones, es recomendable que el empleador <b>revise el campo “Remuneración 9”</b> <a class="linkSubrayado" href="#" onClick="javascript:window.open('/modules/servicio/img4.php',null,'height=253,width=582,status=no,toolbar=no ,menubar=no,location=no,top=5, left=20');">[ver imagen]</a> <a class="linkSubrayado" target="_blank" href="/novedades/23">teniendo en cuenta los topes vigentes</a>. Allí deben reflejarse la sumatoria de los montos de conceptos remunerativos brutos, percibidos por el trabajador en el mes.</p>
