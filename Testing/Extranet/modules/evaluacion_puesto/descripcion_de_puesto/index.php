...
<table border="0" bgcolor="#FFFFFF" cellspacing="0" width="293">
	<tr>
		...
		<td style="border-right:1px solid #C0C0C0; border-top:1px solid #C0C0C0; border-bottom:1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; " bgcolor="#807F84">
			<select id="UsuarioAEvaluar" name="UsuarioAEvaluar" size="1" style="color: #808080; font-family: Trebuchet MS; font-size: 8pt; border: 1px solid #808080; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" onChange="cambiarEvaluado(this.value)">
...
$RCparams = array(":idusuario" => $_SESSION["idUsuario"]);
$RCquery = 
...
UNION ALL
	 SELECT pl_id id, pl_empleado detalle
		...
		WHERE pl_rrhh = :idusuario
			AND pl_fechabaja IS NULL
 ORDER BY 2";
$RCselectedItem = $_SESSION["idEvaluado"];
FillCombo(false);
?>
document.getElementById('UsuarioAEvaluar').focus();
</script>
<?
