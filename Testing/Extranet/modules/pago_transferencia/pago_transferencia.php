...
?>
	...
	<body onLoad="inicial()" link="#336699" vlink="#336699" alink="#336699" leftmargin="2" rightmargin="2">
											...
											<b>
												...
												<font face="Trebuchet MS" style="font-size: 8pt" color="#336699">
													<a target="_self" href="javascript:mostrar('capa1')" onclick="mostrar('capa1');ocultar('capa2');ocultar('capa3');" ondblclick="ocultar('capa1')" id="mas" onChange="inicial()">
														<span style="text-decoration: none"><font color="#05459C">[+]</font></span>
													</a>
												</font>
...
?>
						...
						<form action="subir_archivo.php" enctype="multipart/form-data" id="formSubirArchivo" method="post" name="formSubirArchivo" onSubmit="return ValidarForm(formSubirArchivo)">
							<div id='capa3'>
								<table id="table22">	
									<tr>
										<td width="700">
														...
														<table border="0" width="710" cellspacing="0" cellpadding="0" id="table24">
															<tr>
																<td align="center" style="padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
																	<input id="archivo" name="archivo" style="float:left;" title="Archivo" type="file" validar="true">
																</td>
																<td align="center" style="padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
