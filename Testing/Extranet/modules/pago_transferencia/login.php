...
<table border="0" width="755" height="422" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" bordercolor="#FFFFFF" id="table4">
	<tr>
		<td colspan="3" height="96" width="755">
			<p align="center">
			<img border="0" src="images/top.jpg" width="755" height="96"></td>
	</tr>
		<tr>
	...
	<tr>
		<td height="19" width="318">
			<p align="right">
				...
				<font face="Trebuchet MS" size="2" color="#807F84">Usuario</font></span><font face="Trebuchet MS" style="font-size: 10pt; font-weight:700" color="#807F84">:&nbsp;</font><font face="Trebuchet MS">
				</font>
			</p>
		</td>
...
?>
	<tr>
		...
		<td width="210" height="20">
			<input id="psn" name="psn" size="40" type="password" style="font-family: Trebuchet MS; font-size: 8pt; border: 1px solid #808080; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #FFFFFF; color:#808080"><font face="Trebuchet MS">
			</font>
		</td>
		<td height="20" width="227"></td>
	</tr>
