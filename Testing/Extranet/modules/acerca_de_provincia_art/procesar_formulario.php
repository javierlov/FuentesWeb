...
try {
	...
	$params = array(":tipo_doc" => nullIfCero(substr($_POST["tipoDocumento"], 0, 8)),
									...
									":remuneracion_pretendida" => nullIfCero(str_replace(".", ",", floatval($_POST["remuneracion"]))),
	...
	$sql =
		"INSERT INTO rrhh.rcv_curriculumvitae
								(tipo_doc, nro_doc, nombre_1, nombre_2, apellido_1, apellido_2, fec_nacimiento, sexo,
								 estado_civil, fec_estado_civil, apellido_casada, pais_nacimiento, nacionalidad, fec_ingreso_pais,
								 cantidad_hijos, foto_postulante, fecha_ingreso_curriculum, referencias, procedencia,
								 remuneracion_pretendida, telefono_personal, telefono_celular, email, dir_calle, dir_nro, dir_piso,
								 dir_dpto, dir_torre, dir_manzana, dir_sector, cod_postal, localidad, provincia, partido, zona,
								 pais, nivel_1, completo_1, titulo_1, institucion_1, carrera_1, fecha_desde_1, fecha_hasta_1,
								 promedio_1, rango_1, estudia_actualmente_1, nivel_2, completo_2, titulo_2, institucion_2, carrera_2,
								 fecha_desde_2, fecha_hasta_2, promedio_2, rango_2, estudia_actualmente_2, nivel_3, completo_3,
								 titulo_3, institucion_3, carrera_3, fecha_desde_3, fecha_hasta_3, promedio_3, rango_3,
								 estudia_actualmente_3, nivel_4, completo_4, titulo_4, institucion_4, carrera_4, fecha_desde_4,
								 fecha_hasta_4, promedio_4, rango_4, estudia_actualmente_4, cargo_anterior_1, empresa_1,
								 tarea_desempenada_1, fec_desde_1, fec_hasta_1, remuneracion_1, causa_baja_1, cargo_anterior_2,
								 empresa_2, tarea_desempenada_2, fec_desde_2, fec_hasta_2, remuneracion_2, causa_baja_2,
								 cargo_anterior_3, empresa_3, tarea_desempenada_3, fec_desde_3, fec_hasta_3, remuneracion_3,
								 causa_baja_3, cargo_anterior_4, empresa_4, tarea_desempenada_4, fec_desde_4, fec_hasta_4,
								 remuneracion_4, causa_baja_4, idioma_1, lee_nivel_1, habla_nivel_1, escribe_nivel_1, idioma_2,
								 lee_nivel_2, habla_nivel_2, escribe_nivel_2, idioma_3, lee_nivel_3, habla_nivel_3, escribe_nivel_3,
								 idioma_4, lee_nivel_4, habla_nivel_4, escribe_nivel_4, desc_curso_1, tipo_curso_1, fec_curso_1,
								 instituto_1, desc_curso_2, tipo_curso_2, fec_curso_2, instituto_2, desc_curso_3, tipo_curso_3,
								 fec_curso_3, instituto_3, desc_curso_4, tipo_curso_4, fec_curso_4, instituto_4, esp_tipo_1,
								 esp_elemento_1, esp_nivel_1, esp_tipo_2, esp_elemento_2, esp_nivel_2, esp_tipo_3, esp_elemento_3,
								 esp_nivel_3, esp_tipo_4, esp_elemento_4, esp_nivel_4, fecha_alta, foto, cv)
				 VALUES (:tipo_doc, :nro_doc, :nombre_1, :nombre_2, :apellido_1, :apellido_2, TO_DATE(:fec_nacimiento, 'dd/mm/yyyy'), :sexo,
								 :estado_civil, :fec_estado_civil, :apellido_casada, :pais_nacimiento, :nacionalidad, :fec_ingreso_pais,
								 :cantidad_hijos, :foto_postulante, SYSDATE, :referencias, :procedencia,
								 :remuneracion_pretendida, :telefono_personal, :telefono_celular, :email, :dir_calle, :dir_nro, :dir_piso,
								 :dir_dpto, :dir_torre, :dir_manzana, :dir_sector, :cod_postal, :localidad, :provincia, :partido, :zona,
								 :pais, :nivel_1, :completo_1, :titulo_1, :institucion_1, :carrera_1, :fecha_desde_1, :fecha_hasta_1,
								 :promedio_1, :rango_1, :estudia_actualmente_1, :nivel_2, :completo_2, :titulo_2, :institucion_2, :carrera_2,
								 ...
								 :estudia_actualmente_3, :nivel_4, :completo_4, :titulo_4, :institucion_4, :carrera_4, :fecha_desde_4,
								 :fecha_hasta_4, :promedio_4, :rango_4, :estudia_actualmente_4, :cargo_anterior_1, :empresa_1,
								 :tarea_desempenada_1, TO_DATE(:fec_desde_1, 'dd/mm/yyyy'), :fec_hasta_1, :remuneracion_1, :causa_baja_1, :cargo_anterior_2,
								 :empresa_2, :tarea_desempenada_2, TO_DATE(:fec_desde_2, 'dd/mm/yyyy'), :fec_hasta_2, :remuneracion_2, :causa_baja_2,
								 :cargo_anterior_3, :empresa_3, :tarea_desempenada_3, TO_DATE(:fec_desde_3, 'dd/mm/yyyy'), :fec_hasta_3, :remuneracion_3,
								 :causa_baja_3, :cargo_anterior_4, :empresa_4, :tarea_desempenada_4, TO_DATE(:fec_desde_4, 'dd/mm/yyyy'), :fec_hasta_4,
								 :remuneracion_4, :causa_baja_4, :idioma_1, :lee_nivel_1, :habla_nivel_1, :escribe_nivel_1, :idioma_2,
								 :lee_nivel_2, :habla_nivel_2, :escribe_nivel_2, :idioma_3, :lee_nivel_3, :habla_nivel_3, :escribe_nivel_3,
								 :idioma_4, :lee_nivel_4, :habla_nivel_4, :escribe_nivel_4, :desc_curso_1, :tipo_curso_1, TO_DATE(:fec_curso_1, 'dd/mm/yyyy'),
								 :instituto_1, :desc_curso_2, :tipo_curso_2, TO_DATE(:fec_curso_2, 'dd/mm/yyyy'), :instituto_2, :desc_curso_3, :tipo_curso_3,
								 TO_DATE(:fec_curso_3, 'dd/mm/yyyy'), :instituto_3, :desc_curso_4, :tipo_curso_4, TO_DATE(:fec_curso_4, 'dd/mm/yyyy'), :instituto_4, :esp_tipo_1,
								 :esp_elemento_1, :esp_nivel_1, :esp_tipo_2, :esp_elemento_2, :esp_nivel_2, :esp_tipo_3, :esp_elemento_3,
								 :esp_nivel_3, :esp_tipo_4, :esp_elemento_4, :esp_nivel_4, SYSDATE, :foto, :cv)";
...
<script type="text/javascript">
	...
	window.parent.recargarCaptcha(window.parent.document);
</script>