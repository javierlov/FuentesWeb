...
$grilla->addColumn(new Column("S", -1, true, false, -1, "btnVer", "/index.php?pageid=28", "GridFirstColumn", -1, false, -1, "Ver Solicitud"));
$grilla->addColumn(new Column("C", 0, true, false, -1, "btnCarta", "/index.php?pageid=29", "GridFirstColumn", -1, false, -1, "Ver Carta"));
$grilla->addColumn(new Column("A", 0, true, false, -1, "btnAfiliacion", "/index.php?pageid=30", "GridFirstColumn", -1, false, -1, "Afiliar"));
$grilla->addColumn(new Column("F817", 0, true, false, -1, "btnPdf", "/index.php?pageid=88", "GridFirstColumn", -1, false, -1, "Imprimir Formulario 817"));
