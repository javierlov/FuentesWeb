...
<div class="ContenidoSeccion" style="margin-top:15px;">
	...
	<form action="/modules/usuarios_registrados/preventores/buscar_formulario_busqueda.php" id="formImpresionFormularios" method="post" name="formImpresionFormularios" target="iframeProcesando" onSubmit="return submitForm(true)">
		...
		<div style="margin-top:4px;">
			...
			<select id="establecimiento" name="establecimiento" style="width:400px;" onChange="document.getElementById('idEstablecimiento').value = this.value;"></select>
		</div>
		<div style="margin-top:4px;">
		...
		<div style="margin-top:4px;">
			...
			<select id="preventor" name="preventor" onChange="document.getElementById('idPreventor').value = this.value;"></select>
		</div>
		<div style="margin-top:4px;">
			...
			<select id="provincia" name="provincia" onChange="document.getElementById('idProvincia').value = this.value;"></select>
		</div>
...
<?
	...
	$RCquery =
	 ...
	 ORDER BY 2";
	$RCselectedItem = $_SESSION["BUSQUEDA_IMPRESION_FORMULARIOS"]["idEstablecimiento"];
	FillCombo();
	...
	$RCquery =
	 ...
	 ORDER BY 2";
	$RCselectedItem = $_SESSION["BUSQUEDA_IMPRESION_FORMULARIOS"]["idPreventor"];
	FillCombo();
	...
	$RCquery =
	 ...
	 ORDER BY 2";
	$RCselectedItem = $_SESSION["BUSQUEDA_IMPRESION_FORMULARIOS"]["idProvincia"];
	FillCombo();
?>
