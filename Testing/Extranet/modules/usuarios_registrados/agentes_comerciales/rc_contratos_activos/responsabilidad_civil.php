	...
	<div class="ContenidoSeccion" style="margin-top:12px;">
		<div align="left" style="color:#211e1e; font-size:8pt;">
			...
			<div class="ContenidoSeccion" style="margin-left:32px; margin-top:16px; width:626px;">
				...
				<div align="center" style="background-color:#fff; float:left;">
					<input <?= ($rowPoliza["PR_SUMAASEGURADA"] == "250000")?"checked":""?> <?= ($existe)?"disabled":""?> id="sumaAseguradaRC" name="sumaAseguradaRC" style="float:left; margin-top:14px;" type="radio" value="250000" />
					<div id="divSumaAsegurada250" style="border-left:1px solid #676767; border-top:1px solid #676767; cursor:default; float:left; font-weight:700; height:22px; margin-left:-2px; padding-bottom:2px; padding-top:10px; width:150px;">$250.000</div>
				...
				<div align="center" style="background-color:#fff; float:left;">
					<input <?= ($rowPoliza["PR_SUMAASEGURADA"] == "500000")?"checked":""?> <?= ($existe)?"disabled":""?> id="sumaAseguradaRC" name="sumaAseguradaRC" style="float:left; margin-top:14px;" type="radio" value="500000" />
					<div id="divSumaAsegurada500" style="border-left:1px solid #676767; border-top:1px solid #676767; cursor:default; float:left; font-weight:700; height:22px; margin-left:-2px; padding-bottom:2px; padding-top:10px; width:150px;">$500.000</div>
				...
				<div align="center" style="background-color:#fff; float:left;">
					<input <?= ($rowPoliza["PR_SUMAASEGURADA"] == "1000000")?"checked":""?> <?= ($existe)?"disabled":""?> id="sumaAseguradaRC" name="sumaAseguradaRC" style="float:left; margin-top:14px;" type="radio" value="1000000" />
					<div id="divSumaAsegurada1000" style="border-bottom:1px solid #676767; border-left:1px solid #676767; cursor:default; border-top:1px solid #676767; float:left; font-weight:700; height:22px; margin-left:-2px; padding-bottom:2px; padding-top:10px; width:150px;">$1.000.000</div>
			...
			<div id="divPoliza" style="clear:left; display:<?= ($existe)?"block":"none"?>;">
				<div style="border:1px solid; float:left; margin-left:8px; margin-top:16px; padding:2px;">
					...
					<div style="border-right:0px solid; float:left; margin-top:4px; padding-right:4px;">
						...
						<select id="tarjetaCredito" name="tarjetaCredito" style="display:none; vertical-align:4px; width:208px;"></select>
						<select disabled id="tarjetaCreditoFalso" name="tarjetaCreditoFalso" style="vertical-align:4px; width:208px;"><option value="-1">- SELECCIONAR -</option></select>
						<br />
				...
				<div style="margin-left:8px; margin-top:16px;">
					...
					<div style="margin-left:8px; margin-top:4px;">
						...
						<select <?= ($existe)?"disabled":""?> id="sexo" name="sexo"></select>
					</div>
					<div style="margin-left:8px; margin-top:4px;">
						<label for="cargo" style="margin-left:4px;">Cargo/Personería</label>
						<select <?= ($existe)?"disabled":""?> id="cargo" name="cargo"></select>
...
$RCquery =
 ...
 ORDER BY 2";
$RCselectedItem = $rowPoliza["PR_ORIGENPAGO"];
FillCombo();
...
UNION ALL
	 SELECT 'M', 'Masculino'
		 FROM DUAL
 ORDER BY 2";
$RCselectedItem = $rowPoliza["PR_SEXO"];
FillCombo();
...
$RCquery =
 ...
 ORDER BY 2";
$RCselectedItem = $rowPoliza["PR_IDCARACTERFIRMA"];
FillCombo();
?>
