...
$pdf = new FPDI();
$pdf->setSourceFile($_SERVER["DOCUMENT_ROOT"]."/modules/usuarios_registrados/agentes_comerciales/comisiones/templates/ingresos_brutos_16.pdf");
...
$pdf->Ln(12.2);
$pdf->Cell(62);
$pdf->Cell(86, 0, "Provincia Aseguradora de Riesgos de Trabajo S.A.");
...
$pdf->Ln(6.4);
$pdf->Cell(62);
$pdf->Cell(0, 0, "Carlos Pellegrini 91 1º Piso - Capital Federal (C.P. 1009)");
...
$pdf->Ln(8.2);
$pdf->Cell(52);
$pdf->Cell(72, 0, $row["NOMBREENTIDAD"]);
...
$pdf->Ln(7.2);
$pdf->Cell(53);
$pdf->Cell(36, 0, $row["MONTOIMPONIBLE"]);

$pdf->Cell(20);
$pdf->Cell(18, 0, $row["ALICUOTA"]);
...
$pdf->Image("http://extranet-desa.artprov.com.ar/modules/usuarios_registrados/agentes_comerciales/comisiones/images/firma.jpg", 137, 214, 34, 31); //336, 313
