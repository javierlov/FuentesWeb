...
$sql =
	"SELECT ib_inscripcion agenteretencion,
					(art.comision.get_tasaib(il_provincia, '01', en_id, NULL) * 100) || ' %' alicuota,
...
UNION ALL
	 SELECT ib_inscripcion agenteretencion,
					(art.comision.get_tasaib(il_provincia, '01', NULL, ev_id) * 100) || ' %' alicuota,
					to_char(lc_fechaliq, 'YYYY') anoretencion,
...
$pdf = new FPDI();
$pdf->setSourceFile($_SERVER["DOCUMENT_ROOT"]."/modules/usuarios_registrados/agentes_comerciales/comisiones/templates/ingresos_brutos_1.pdf");
...
$numeroComprobante = str_pad($row["NROCOMPROBANTE"], 10, "0", STR_PAD_LEFT);
$pdf->Ln(41.6);
$pdf->Cell(32);
$pdf->Cell(80, 0, substr($numeroComprobante, 0, 4)."-2005-".substr($numeroComprobante, 4));
...
$pdf->Ln(5.6);
$pdf->Cell(40);
$pdf->Cell(80, 0, $row["FECHARETENCION"]);
...
$pdf->SetFont("Arial", "", 10);
$pdf->Cell(4);
$pdf->Cell(84, 0, "Provincia Aseguradora de Riesgos de Trabajo S.A.");
...
$pdf->SetFont("Arial", "", 10);
$pdf->Cell(4);
$pdf->Cell(84, 0, "Carlos Pellegrini 91 1º Piso - Capital Federal");

$pdf->SetFont("Arial", "B", 10);
$pdf->Ln(4.8);
$pdf->Cell(64);
$pdf->Cell(40, 0, "Particular");
...
$pdf->Ln(4.8);
$pdf->Cell(108);
$pdf->Cell(84, 0, "Tel: 4819-2800 Fax: 0800-999-1829");

$pdf->SetFont("Arial", "B", 10);
$pdf->Ln(26);
$pdf->Cell(40);
$pdf->Cell(152, 0, $row["NOMBREENTIDAD"]);

$pdf->Ln(7);
$pdf->Cell(40);
$pdf->Cell(48, 0, $row["CUIT"]);

$pdf->Cell(60);
$pdf->Cell(48, 0, $row["NIB"]);

$pdf->Ln(5.6);
$pdf->Cell(40);
$pdf->Cell(0, 0, $row["CONVENIO"]);
...
$pdf->Ln(28.2);
$pdf->Cell(48);
$pdf->Cell(0, 0, "Dto. 356/78 - CIA DE - Cías de Seguros. Pagos en concepto de comisiones");

$pdf->Ln(5);
$pdf->Cell(48);
$pdf->Cell(0, 0, "a productores de seguros.");
...
$pdf->Ln(4.8);
$pdf->Cell(158);
$pdf->Cell(0, 0, $row["FECHAACTUAL"]);

$pdf->Ln(10.6);
$pdf->Cell(70);
$pdf->Cell(32, 0, $row["MONTOIMPONIBLE"]);
