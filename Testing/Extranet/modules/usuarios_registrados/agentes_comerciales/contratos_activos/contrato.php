...
<div class="ContenidoSeccion" style="padding:4px; margin-left:4px; margin-top:4px; width:720px;">
	<div>
		<label style="margin-left:38px;">Contrato</label>
	...
	<div style="margin-top:2px;">
		<label style="margin-left:35px;">Actividad</label>
...
<div class="ContenidoSeccion" style="padding:4px; margin-left:4px; margin-top:4px; width:720px;">
	<div>
		<label style="margin-left:78px;">Calle</label>
		<span><b><?= $row["CALLE"]?></b></span>
	</div>
	<div style="margin-top:2px;">
		<label style="margin-left:62px;">Número</label>
	...
	<div style="margin-top:2px;">
		<label style="margin-left:50px;">Teléfonos</label>
		<span><b><?= $row["TELEFONOS"]?></b></span>
	</div>
	<div style="margin-top:2px;">
		<span style="margin-left:110px;">Si los datos han cambiado, usted puede imprimir el <a href="<?= getFile("F:/Storage_Extranet/descargables_web/Provincia_ART_Rect_datos.pdf")?>" target="_blank">formulario de validación de datos</a>.</span>
...
<div class="ContenidoSeccion" style="padding:4px; margin-left:4px; margin-top:4px; width:720px;">
	<div>
		<label style="margin-left:15px;">Período Mes/Año</label>
	...
	<div style="margin-top:2px;">
		<label style="margin-left:34px;">Masa Salarial</label>
		<span><b><?= $row["MASASALARIAL"]?></b></span>
	</div>
	<div style="margin-top:2px;">
		<label style="margin-left:25px;">Vigencia Tarifa</label>
		<span><b><?= $row["VIGENCIATARIFA"]?></b></span>
	</div>
	<div style="margin-top:2px;">
		<label style="margin-left:53px;">Suma Fija</label>
		<span><b><?= $row["SUMAFIJA"]?></b></span>
	</div>
	<div style="margin-top:2px;">
		<label style="margin-left:30px;">Porc. Variable</label>
		<span><b><?= $row["PORCVARIABLE"]?></b></span>
	</div>
	<div style="margin-top:2px;">
		<label style="margin-left:19px;">Devengado Mes</label>
		<span><b><?= $row["DEVENGADOS"]?></b></span>
	</div>
	<div style="margin-top:2px;">
		<label style="margin-left:42px;">Pagado Mes</label>
		<span><b><?= $row["PAGOS"]?></b></span>
	</div>
	<div style="margin-top:2px;">
		<label style="margin-left:41px;">Deuda Total</label>
		<span><b><?= $row["DEUDATOTAL"]?></b></span>
	</div>
	<div style="margin-top:2px;">
		<label style="margin-left:68px;">Holding</label>
...
<div class="ContenidoSeccion" style="padding:4px; margin-left:4px; margin-top:4px; width:720px;">
	<div>
		<label style="margin-left:24px;">Ejecutivo Comercial de la Empresa</label>
...
<div class="ContenidoSeccion" style="padding:4px; margin-left:4px; margin-top:4px; width:720px;">
	<div>
		<label style="margin-left:41px;">Cantidad de Siniestros Denunciados</label>
		<span><b><?= $row["CANTIDADSINIESTROSDENUNCIADOS"]?></b></span>
	</div>
	<div style="margin-top:2px;">
		<label style="margin-left:46px;">Cantidad de Siniestros Rechazados</label>
...
-->
	...
	<div style="margin-top:2px;">
		<a href="/index.php?pageid=64&id=<?= $_REQUEST["id"]?>" style="margin-left:167px;">Ver Siniestros</a>
		<a href="/index.php?pageid=64&id=<?= $_REQUEST["id"]?>"><img border="0" src="/images/link.png" style="vertical-align:-4px;" title="Ver Siniestros" /></a>
	</div>
</div>
...
<div class="ContenidoSeccion" style="padding:4px; margin-left:4px; margin-top:4px; width:720px;">
	<div>
		<a href="/index.php?pageid=70&id=<?= $_REQUEST["id"]?>">Emitir Certificado de Cobertura</a>
		<a href="/index.php?pageid=70&id=<?= $_REQUEST["id"]?>"><img border="0" src="/images/link.png" style="margin-left:10px; vertical-align:-4px;" title="Emitir Certificado de Cobertura" /></a>
	</div>
</div>
...
<div class="ContenidoSeccion" style="padding:4px; margin-left:4px; margin-top:4px; width:720px;">
	<div>
		<a href="/index.php?pageid=79&id=<?= $_REQUEST["id"]?>">Emitir Póliza de RC</a>
		<a href="/index.php?pageid=79&id=<?= $_REQUEST["id"]?>"><img border="0" src="/images/link.png" style="margin-left:79px; vertical-align:-4px;" title="Emitir Póliza de RC" /></a>
	</div>
</div>
<?
}
?>
<!-- 14/03/2012 EJV (A pedido de Julia este item no tiene que estar.)
<div class="TituloSeccion" style="display:block; font-size:9pt; margin-top:8px; width:730px;">Nómina de Trabajadores</div>
<div class="ContenidoSeccion" style="padding:4px; margin-left:4px; margin-top:4px; width:720px;">
	<div>
		<a href="/index.php?pageid=52&id=<?= $_REQUEST["id"]?>">Administración de Trabajadores</a>
		<a href="/index.php?pageid=52&id=<?= $_REQUEST["id"]?>"><img border="0" src="/images/link.png" style="margin-left:6px; vertical-align:-4px;" title="Administración de Trabajadores" /></a>
	</div>
</div>
-->
...
<div class="ContenidoSeccion" style="padding:4px; margin-left:4px; margin-top:4px; width:720px;">
	<div>
		<a href="/index.php?pageid=61&id=<?= $_REQUEST["id"]?>">Carga de Denuncia de Siniestros</a>
		<a href="/index.php?pageid=61&id=<?= $_REQUEST["id"]?>"><img border="0" src="/images/link.png" style="vertical-align:-4px;" title="Carga de Denuncia de Siniestros" /></a>
	</div>
</div>
...
<div class="ContenidoSeccion" style="padding:4px; margin-left:4px; margin-top:4px; width:720px;">
	<div>
		<a href="/index.php?pageid=42&id=<?= $_REQUEST["id"]?>&rpt=ec">Estado de Cuenta</a>
		<a href="/index.php?pageid=42&id=<?= $_REQUEST["id"]?>&rpt=ec"><img border="0" src="/images/link.png" style="margin-right:32px; vertical-align:-4px;" title="Ver PDF" /></a>
		<a href="/index.php?pageid=42&id=<?= $_REQUEST["id"]?>&rpt=ec">F817</a>
		<a href="/index.php?pageid=42&id=<?= $_REQUEST["id"]?>&rpt=f817"><img border="0" src="/images/link.png" style="margin-right:32px; vertical-align:-4px;" title="Ver PDF" /></a>
		<a href="/index.php?pageid=42&id=<?= $_REQUEST["id"]?>&rpt=ec">F801C</a>
		<a href="/index.php?pageid=42&id=<?= $_REQUEST["id"]?>&rpt=f801c"><img border="0" src="/images/link.png" style="vertical-align:-4px;" title="Ver PDF" /></a>
	</div>
</div>
...
<div class="ContenidoSeccion" style="padding:4px; margin-left:4px; margin-top:4px; width:720px;">
	<div>
		<a href="/index.php?pageid=33&id=<?= $_REQUEST["id"]?>">Ver Datos Legales</a>
		<a href="/index.php?pageid=33&id=<?= $_REQUEST["id"]?>"><img border="0" src="/images/link.png" style="vertical-align:-4px;" title="Ver Formularios" /></a>
	</div>
</div>
