...
function shutDownFunction() {
	...
	if (intval(time() - $_SESSION["BUSQUEDA_CONTRATOS_ACTIVOS"]["horaInicioBusqueda"]) > 10800) {
?>
...
$grilla = new Grid();
$grilla->addColumn(new Column("V", 0, true, false, -1, "btnEditar", "/index.php?pageid=83", "", -1, true, -1, "Ver"));
