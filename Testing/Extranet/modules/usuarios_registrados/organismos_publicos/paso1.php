...
<div class="ContenidoSeccion" id="divPaso1" style="margin-top:16px;">
	<b>Proceso de carga de datos:</b>
	<br>	Descargue en su computadora la plantilla en formato Microsoft Excel haciendo clic aquí&nbsp; <a target="_blank" href="/modules/usuarios_registrados/organismos_publicos/descargables/plantilla.xls"><img border="0" src="/modules/usuarios_registrados/images/icoEXCEL.gif"></a></br>
	En esta plantilla deberá cargar o pegar los datos obligatorios <font color=#FF0000>(aquellos que se encuentran en rojo)</font>.<br><br>
	...
	<p>Recuerde que luego podrá completar los datos no obligatorios. Tenga en cuenta que de no remitirlos en esta oportunidad, Provincia ART podrá solicitárselos para la realización de trámites administrativos; los mismos son: Apellido y Nombre, Fecha de Ingreso, Dirección (Calle, Número, Piso, Departamento, Código Postal, Localidad, Provincia), Tarea y Fecha de Nacimiento.</p>
	<form action="/modules/usuarios_registrados/organismos_publicos/procesar_archivo.php" enctype="multipart/form-data" id="formArchivo" method="post" name="formArchivo" target="iframeArchivo">
		...
		<table>
			<tr>
				<td><input class="InputText" ext="xls" id="archivo" name="archivo" style="width:710px;" title="Archivo" type="file" validar="true" validarArchivo="true" value=""></td>
			</tr>
			<tr>
				<td>
	...
	<br />
	<p><input class="btnVolver" type="button" value="" onClick="window.location.href = '/index.php?pageid=46'" /></p>
