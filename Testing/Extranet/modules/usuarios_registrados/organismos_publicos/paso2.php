...
<div class="ContenidoSeccion" id="divPaso2" style="margin-top:16px;">
	...
	<div style="border:1px solid; left:280px; padding:8px; position:relative; top:-147px; width:420px;">A continuación Ud. podrá determinar cuales son los conceptos de su liquidación de sueldos que deben considerarse como remunerativos para el cálculo del seguro de Ley de Riesgos del Trabajo.</div>
