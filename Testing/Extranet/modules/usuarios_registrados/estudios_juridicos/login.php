...
if ((isset($_SESSION["isAgenteComercial"])) and ($_SESSION["isAgenteComercial"])) {
	echo "<script type='text/javascript'>window.location.href = '/Estudio-Juridico'</script>";
	exit;
}
...
<div class="TituloSeccion" style="width:608px;">Acceso exclusivo Estudio Juridico</div>
<form action="/index.php?pageid=43&login=t" id="formLogin" method="post" name="formLogin">

	
	<input id="cc" name="cc" type="hidden" value="">
	<p class="ContenidoSeccion" style="margin-left:24px; margin-top:16px;">
		Acceso exclusivo para Estudio Juridico.<br />
...
?>
	<div>
		<input class="btnIngresar" name="btnIngresar" style="margin-left:408px; position:relative; top:-35px;" type="button" value=""
		onClick="enviarForm()" />
	</div>
<?php
}
