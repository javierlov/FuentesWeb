...
require_once($_SERVER["DOCUMENT_ROOT"]."/modules/usuarios_registrados/estudios_juridicos/JuiciosParteDemandada/AdminWebForm.Form.php");
...
?>
	<head>
		...
		<link href="/modules/usuarios_registrados/estudios_juridicos/Estilos/legales.form.css" rel="stylesheet" type="text/css" />		
		
		<script type="text/javascript" src="/js/jquery.js"></script>
		<script src="/modules/usuarios_registrados/estudios_juridicos/JuiciosParteDemandada/js/funcionesjuridicos.js" type="text/javascript"></script>
