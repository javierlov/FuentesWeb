...
<table border="0" width="100%" id="table1" cellspacing="0" cellpadding="0">
	...
	<td width="84%" height="83" style="border-bottom: 1px dotted #999999; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		...
		<table border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<p style="margin:0 10px; ">
				<font face="Trebuchet MS" color="#999999" style="font-size: 8pt">
				Para descargar el formulario haga <u><a href="#" onClick="descargarPdf()">click aqui.</a></u><br>
	...
	<tr>
		...
		Para conocer las nuevas condiciones de su contrato de afiliación en virtud de las Resoluciones SRT 463/09 y 529/09,<a href="Descargables/Contrato_de_Afiliacion.pdf" target="_blank"> haga click aquí.</a>
 <br>
		</font>
		</td>
	</tr>
