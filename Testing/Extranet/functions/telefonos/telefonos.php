...
<html>
	<head>
		...
		<style type="text/css">
			...
			.GridEmpty {
				border: none;
				background-image: url(/images/tel_not_found.gif);
				height: 50px;
				width: 237px;
			}
		</style>
	...
	<body style="margin:0;" onLoad="formTelefonos.submit()">
		...
		<form action="/functions/telefonos/telefonos_busqueda.php" id="formTelefonos" method="post" name="formTelefonos" target="iframeProcesando">
			...
			<div style="color:#211e1e; font-family:Trebuchet MS; font-size:8pt; margin-left:2px;">
