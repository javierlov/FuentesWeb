<script type="text/javascript">
	...
	function mostrarVentanaCambioEntidad() {
		...
		divWin.load('iframe', '/cambiar_entidad.php', 'Cambiar Entidad en la navegación');
		divWin.show();
	}
</script>
<map name="mapTop">
...
<map name="MapBottom">
	<area href="http://es-la.facebook.com/people/Grupo-Banco-Provincia/100001245104630" target="_blank" shape="rect" coords="6, 5, 23, 21" />
	<area href="http://twitter.com/GrupoBancoPcia" target="_blank" shape="rect" coords="30, 6, 47, 20" />
</map>
