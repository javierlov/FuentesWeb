...
<script type="text/javascript">
	with (parent.document) {
		getElementById('codigoPostal2').value = '<?= $ids[0]?>';
		getElementById('localidad2').value = '<?= $ids[1]?>';
	}
...
$sql =
	"SELECT DISTINCT mp_cpostal || '-' || mp_localidad ¿id?, ¿mp_cpostal?, ¿mp_localidad?, ¿mp_provincia?, 'Seleccionar' ¿seleccionar?
		 FROM tmp_domicilios
