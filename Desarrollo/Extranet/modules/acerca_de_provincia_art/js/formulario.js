function agregarCurso() {
	with (document) {
		if (getElementById('curso2').style.display != 'inline') {
		...
		else if (getElementById('curso4').style.display != 'inline') {
...
function agregarEspecializacion() {
	with (document) {
		if (getElementById('especializacion2').style.display != 'inline') {
		...
		else if (getElementById('especializacion4').style.display != 'inline') {
...
function agregarEstudio() {
	with (document) {
		if (getElementById('formacion2').style.display != 'inline') {
		...
		else if (getElementById('formacion4').style.display != 'inline') {
...
function agregarExperienciaLaboral() {
	with (document) {
		if (getElementById('experienciaLaboral2').style.display != 'inline') {
		...
		else if (getElementById('experienciaLaboral4').style.display != 'inline') {
...
function agregarIdioma() {
	with (document) {
		if (getElementById('divIdioma2').style.display != 'inline') {
		...
		else if (getElementById('divIdioma4').style.display != 'inline') {
