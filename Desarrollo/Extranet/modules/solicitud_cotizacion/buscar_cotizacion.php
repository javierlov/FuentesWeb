...
<form action="/modules/solicitud_cotizacion/buscar_cotizacion_busqueda.php" id="formBuscarSolicitudCotizacion" method="post" name="formBuscarSolicitudCotizacion" target="iframeProcesando" onSubmit="return submitForm()">
	...
	<div class="ContenidoSeccion">
		...
		<div style="margin-left:76px; margin-top:6px;">
			<label>C.U.I.T.</label>
		...
		<div style="margin-left:51px; margin-top:8px;">
...
?>
		<div style="margin-top:24px;">
			<input class="btnNuevaCotizacion" type="button" value="" onClick="window.location.href='/cotizacion'" />
		</div>
<?
}
?>
...
<div id="divMsg" style="background-color:#f0f0f0; margin-top:24px; padding:12px">
	...
	<div style="font-size:7.5pt; font-style:italic; padding-top: 5px; padding-left: 12px; padding-right: 12px; color:#676767">(*) Haga <a class="linkSubrayado" href="/download/PART_CIIUS.pdf" target="_blank">clic aquí</a> para ver el listado de CIIUs considerados para cotizaciones automáticas.</div>
</div>
