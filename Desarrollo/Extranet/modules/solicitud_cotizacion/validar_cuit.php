...
?>
<script src="/modules/solicitud_cotizacion/js/cotizacion.js?rnd=<?= date("Ymdhmi")?>" type="text/javascript"></script>
<script type="text/javascript">
	with (window.parent.document) {
		// Asigno el nombre que devuelve la SRT..
		getElementById('razonSocial').value = '<?= $razonSocial?>';
		if (getElementById('razonSocial').value == '')
			getElementById('razonSocial').readOnly = false;
		else
			getElementById('razonSocial').readOnly = true;

		verificarPCP(window.parent.document);
