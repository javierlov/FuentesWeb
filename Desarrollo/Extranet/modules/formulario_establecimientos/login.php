						...
						<table border="0" width="755" height="422" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" bordercolor="#FFFFFF">
							<tr>
								<td colspan="4" height="86" width="755">
									<p align="center">
									<font face="Neo Sans" style="font-size: 9pt"><img border="0" src="images/top.jpg" /></font>
								</td>
							</tr>
								<tr>
							...
							<tr>
								...
								<td width="381" height="20">
									<font face="Trebuchet MS" style="font-size: 10pt; font-weight:700" color="#807F84">
										<input id="cuit" maxlength="11" name="cuit" style="font-family: Trebuchet MS; font-size: 8pt; border: 1px solid #808080; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #FFFFFF; color:#808080" type="text" value="<?= $cuit?>" />
									</font>
								</td>
							...
							<tr>
								<td width="755" height="6" colspan="4"></td>
							</tr>
							<tr>
							...
							<tr>
								<td width="755" height="14" colspan="4"></td>
							</tr>
							<tr>
