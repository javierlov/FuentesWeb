...
$grilla->addColumn(new Column("EC", -1, true, false, -1, "btnDescargar", "/estado-cuenta/ec", "gridFirstColumn", -1, false, -1, "Descargar Estado de Cuenta", false, "", "button", -1, -1, true));
$grilla->addColumn(new Column("F817", 0, true, false, -1, "btnDescargar", "/estado-cuenta/f817", "gridFirstColumn", -1, false, -1, "Descargar F817", false, "", "button", -1, -1, true));
$grilla->addColumn(new Column("F801C", 0, true, false, -1, "btnDescargar", "/estado-cuenta/f801c", "gridFirstColumn", -1, false, -1, "Descargar F801C", false, "", "button", -1, -1, true));
