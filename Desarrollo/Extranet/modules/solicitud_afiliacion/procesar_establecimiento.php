...
try {
	...
	if (!isset($_POST["tipoEstablecimiento"]))
		$_POST["tipoEstablecimiento"] = -1;
	...
	$params = array(":dfechafinobra" => $_POST["fechaFinObra"],
									...
									":ncodigosrt" => nullIsEmpty($_POST["codigoSrt"]),
