...
var idEvento = 0;
  ...
  function AsignarEventos() {	  
	...
	$('#dialogElimEvento').dialog({autoOpen: false});
		
	$("#btnFecha").click(CompletarFechaAsignacion);
	$("#btnFechaVencimiento").click(CompletarFechaVencimientoAsignacion);		
	
	if(mensajeResultado != ''){
		muestraDialogMsj('Evento', '', mensajeResultado, 1);
		mensajeResultado = '';		
	}
