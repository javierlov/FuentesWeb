...
<div class="ContenidoSeccion" style="margin-top:8px; width:712px;">
	...
	<div id="divLiquidaciones" style="border:2px solid #0f539c;">
		<form action="/comisiones/liquidaciones" id="formConsultaLiquidaciones" method="post" name="formConsultaLiquidaciones" onSubmit="return ValidarForm(formConsultaLiquidaciones)">
