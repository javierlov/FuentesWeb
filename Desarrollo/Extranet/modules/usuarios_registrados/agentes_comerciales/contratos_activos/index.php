...
if (!isset($_SESSION["BUSQUEDA_CONTRATOS_ACTIVOS"]))
	$_SESSION["BUSQUEDA_CONTRATOS_ACTIVOS"] = array("buscar" => "N",
																									...
																									"solicitudTraspaso" => "");
?>
<script src="/modules/usuarios_registrados/agentes_comerciales/contratos_activos/js/contratos_activos.js?rnd=<?= date("YmdHis")?>" type="text/javascript"></script>
...
<form action="/modules/usuarios_registrados/agentes_comerciales/contratos_activos/index_busqueda.php" id="formBuscarContrato" method="post" name="formBuscarContrato" target="iframeProcesando" onSubmit="return submitForm()">
	...
	<div class="ContenidoSeccion" style="margin-left:-16px; margin-top:25px;">
		<div style="margin-left:72px;">
			...
			<input autofocus id="contrato" maxlength="8" name="contrato" style="width:56px;" type="text" value="<?= $_SESSION["BUSQUEDA_CONTRATOS_ACTIVOS"]["contrato"]?>" />
		</div>
		...
		<div style="margin-left:76px; margin-top:4px;">
		...
		<div style="margin-left:141px; margin-top:4px;">
