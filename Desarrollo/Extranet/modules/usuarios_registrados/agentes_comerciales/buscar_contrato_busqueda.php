...
function getPage($destino) {
	switch ($destino) {
		case "cc":
			return "/certificados-cobertura";
		case "ds":
			return "/denuncia-siniestros";
		case "nt":
...
$grilla = new Grid();
$grilla->addColumn(new Column("V", 0, true, false, -1, "btnEditar", getPage($destino), "", -1, true, -1, "Ver", false, "", "button", -1, -1, true));
