...
$grilla = new Grid();
$grilla->addColumn(new Column("", 8, true, false, -1, "BotonInformacion", "/denuncia-siniestros/denuncia", "gridFirstColumn", -1, true, -1, "", false, "", "button", -1, -1, true));
$grilla->addColumn(new Column("Nº Transacción"));
$grilla->addColumn(new Column("Acción"));
$grilla->addColumn(new Column("Fecha Recepción"));
$grilla->addColumn(new Column("Siniestrado"));
