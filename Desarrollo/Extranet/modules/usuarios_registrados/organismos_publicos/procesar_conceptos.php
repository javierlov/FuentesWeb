...
try {
	...
	if ($_POST["esAlta"] == "T") {
		$params = array(":antiguedad" => $antiguedad,
										...
										":viaticos" => $viaticos);
		$sql =
			"INSERT INTO emi.icr_conceptoremunerativo (cr_antiguedad, cr_bonus, cr_contrato, cr_fechaalta, cr_id, cr_otros, cr_periodo, cr_premios, cr_presentismo, cr_refrigerio, cr_usualta, cr_viaticos)
...
<script type="text/javascript">
	window.parent.location.href = '/carga-nomina-personal/paso-3/<?= $_POST["idTmp"]?>/<?= $_POST["amw"]?>/<?= $_POST["periodoProcesado"]?>';
</script>