...
<div class="ContenidoSeccion" style="margin-top:16px;">
	...
	<p>Provincia ART verificará los datos contenidos, y posteriormente si los mismos son correctos le remitirá un e-mail a <b><?= $_SESSION["email"]?></b> informándole que puede descargar el Resúmen No Suss desde <a class="linkSubrayado" href="/impresion-resumenes">aquí</a>.</p>
...
?>
		<td style="color:#000; font-weight:bold;">
			Se ha completado el dato sueldo cuando corresponde completar el dato remuneración imponible. Para mayor información haga <a href="/download/P_ART_Instructivo_extranet.pdf" target="_blank">clic</a> aquí para descargar el documento.
		</td>
<?
	}
...
?>
		<td style="color:#000; font-weight:bold;">
			Se ha completado el dato Remuneración Imponible cuando corresponde completar el dato sueldo. Para mayor información haga <a href="/descargas/PART_DDJJ_Base_imponible_Extra_SUSS.pdf" target="_blank">clic</a> aquí para descargar el documento.
		</td>
<?
	}
