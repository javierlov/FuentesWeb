...
$sql.=
	" UNION ALL
		 ...
		 ORDER BY 1, 2";
$comboLocalidadCombo = new Combo($sql, "localidadCombo".$_REQUEST["prefijo"], $_REQUEST["l"]);
...
$comboLocalidadCombo->setOnChange("cambiarLocalidad(this.value, \'".$_REQUEST["prefijo"]."\')");
