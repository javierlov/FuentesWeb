...
if ($_REQUEST["cp"] == "") {
?>
	window.parent.document.getElementById('codigoPostal<?= $_REQUEST["prefijo"]?>').value = '<?= $row["UB_CPOSTAL"]?>';
<?
}

if ($_REQUEST["p"] == -1) {
?>
	window.parent.document.getElementById('provincia<?= $_REQUEST["prefijo"]?>').value = '<?= $row["UB_PROVINCIA"]?>';
<?
}
?>
</script>