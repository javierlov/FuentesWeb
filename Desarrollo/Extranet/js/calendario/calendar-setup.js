...
if(!(params.flat||params.multiple||params.inputField||params.displayArea||params.button)){console.error("Calendar.setup:\n  Nothing to setup (no fields found).  Please check your code");return false;}
...
params.flat=document.getElementById(params.flat);if(!params.flat){console.error("Calendar.setup:\n  Flat specified but can't find parent.");return false;}
