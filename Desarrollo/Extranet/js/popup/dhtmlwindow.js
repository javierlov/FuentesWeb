var dhtmlwindow={imagefiles:['/js/popup/images/min.gif','/js/popup/images/close.gif','/js/popup/images/restore.gif','/js/popup/images/resize.gif'],ajaxbustcache:true,ajaxloadinghtml:'<b>Cargando la página. Aguarde por favor...</b>',minimizeorder:0,zIndexvalue:100,tobjects:[],lastactivet:{},init:function(t){var domwindow=document.createElement("div")
domwindow.id=t
