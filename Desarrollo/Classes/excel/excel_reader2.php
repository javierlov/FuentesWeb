<?php
// En la función "_getCellDetails" se deja fijo el formato de los valores de tipo fecha a d/m/Y..

// Seteo el límite de memoria del script que use esta clase..
...
function gmgetdate($ts = null){
	...
	$arrayfecha = explode(":",gmdate('s:i:G:j:w:n:Y:z:l:F:U',is_null($ts)?time():$ts));
	return(array_comb($k, $arrayfecha ));
	} 
...
// Sobreescribo el formato de las fechas..lo dejo fijo en D/M/Y..
$format = "d/m/Y";
