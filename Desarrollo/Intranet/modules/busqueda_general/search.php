<?php
// ----------------------------------------------------------------------------
// Zoom Search Engine 6.0 (15/Nov/2012)
// PHP search script
...
if (isset($LinkBackURL) == false || strlen($LinkBackURL) < 1)
	$SelfURL = htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, CHARSET);
else
{
	$SelfURL = $LinkBackURL;
}
...
{
	// Insert the form
	$OutputBuffers[$OUTPUT_FORM_SEARCHBOX] = $STR_FORM_SEARCHFOR . " <input autofocus type=\"text\" name=\"zoom_query\" size=\"20\" value=\"".htmlspecialchars($query, ENT_QUOTES, CHARSET)."\" id=\"zoom_searchbox\" class=\"zoom_searchbox\" />\n";
	...
	$OutputBuffers[$OUTPUT_FORM_START] .= "<input type=\"hidden\" name=\"pageid\" value=\"83\" />\n";
	$OutputBuffers[$OUTPUT_FORM_START] .= "<input type=\"hidden\" name=\"busquedaGeneral\" value=\"".$_REQUEST["busquedaGeneral"]."\" />\n";
}
...
$queryForHTML = htmlspecialchars($query, ENT_QUOTES, CHARSET);
...
if ($matches < 3) {
	if ($and == 1 && $NumSearchWords > 1)
		$OutputBuffers[$OUTPUT_SUGGESTION] .= "<div class=\"suggestion\"><br />" . $STR_POSSIBLY_GET_MORE_RESULTS . " <a href=\"".$SelfURL.$LinkBackJoinChar."zoom_query=".$queryForURL.$metaParams."&amp;pageid=83&amp;busquedaGeneral=".$_REQUEST["busquedaGeneral"]."&amp;zoom_per_page=".$per_page.$query_zoom_cats."&amp;zoom_and=0&amp;zoom_sort=".$sort."\">". $STR_ANY_OF_TERMS . "</a>.</div>";
	else if ($UseCats && $cat[0] != -1)
		$OutputBuffers[$OUTPUT_SUGGESTION] .= "<div class=\"suggestion\"><br />" . $STR_POSSIBLY_GET_MORE_RESULTS . " <a href=\"".$SelfURL.$LinkBackJoinChar."zoom_query=".$queryForURL.$metaParams."&amp;pageid=83&amp;busquedaGeneral=".$_REQUEST["busquedaGeneral"]."&amp;zoom_per_page=".$per_page."&amp;zoom_cat=-1&amp;zoom_and=".$and."&amp;zoom_sort=".$sort."\">" . $STR_ALL_CATS . "</a>.</div>";
}
...
{	
	...
	{				
		if ($CatCounter[$catit] > 0)
		{
			...
			{
				$catSummaryItemCount++;
				$OutputBuffers[$OUTPUT_CATSUMMARY] .= "<li><a href=\"".$SelfURL.$LinkBackJoinChar."zoom_query=".$queryForURL.$metaParams."&amp;pageid=83&amp;busquedaGeneral=".$_REQUEST["busquedaGeneral"]."&amp;zoom_cat=".$catit."&amp;zoom_per_page=".$per_page."&amp;zoom_and=".$and."&amp;zoom_sort=".$sort."\">".$catnames[$catit];
...
if ($Spelling == 1)
{
	...
	{
		$OutputBuffers[$OUTPUT_SUGGESTION] .= "<div class=\"suggestion\"><br />" . $STR_DIDYOUMEAN . " <a href=\"".$SelfURL.$LinkBackJoinChar."zoom_query=".urlencode($SuggestStr).$metaParams."&amp;pageid=83&amp;busquedaGeneral=".$_REQUEST["busquedaGeneral"]."&amp;zoom_per_page=".$per_page.$query_zoom_cats."&amp;zoom_and=0&amp;zoom_sort=".$sort."\">". $SuggestStr . "</a>";
		if (strlen($word2) > 0)
			$OutputBuffers[$OUTPUT_SUGGESTION] .= " $STR_OR <a href=\"".$SelfURL.$LinkBackJoinChar."zoom_query=".urlencode($word2).$metaParams."&amp;pageid=83&amp;busquedaGeneral=".$_REQUEST["busquedaGeneral"]."&amp;zoom_per_page=".$per_page.$query_zoom_cats."&amp;zoom_and=".$and."&amp;zoom_sort=".$sort."\">". $word2 . "</a>";
		if (strlen($word3) > 0)
			$OutputBuffers[$OUTPUT_SUGGESTION] .= " $STR_OR <a href=\"".$SelfURL.$LinkBackJoinChar."zoom_query=".urlencode($word3).$metaParams."&amp;pageid=83&amp;busquedaGeneral=".$_REQUEST["busquedaGeneral"]."&amp;zoom_per_page=".$per_page.$query_zoom_cats."&amp;zoom_and=".$and."&amp;zoom_sort=".$sort."\">". $word3 . "</a>";
...
if ($matches > 1)
{
	if ($UseDateTime == 1)
	{
		...
		if ($sort == 1)
			$OutputBuffers[$OUTPUT_SORTING] .= "<a href=\"".$SelfURL.$LinkBackJoinChar."zoom_query=".$queryForURL.$metaParams."&amp;pageid=83&amp;busquedaGeneral=".$_REQUEST["busquedaGeneral"]."&amp;zoom_page=".$page."&amp;zoom_per_page=".$per_page.$query_zoom_cats."&amp;zoom_and=".$and."&amp;zoom_sort=0\">". $STR_SORTBY_RELEVANCE . "</a> / <b>". $STR_SORTEDBY_DATE . "</b>";
		else
			$OutputBuffers[$OUTPUT_SORTING] .= "<b>". $STR_SORTEDBY_RELEVANCE . "</b> / <a href=\"".$SelfURL.$LinkBackJoinChar."zoom_query=".$queryForURL.$metaParams."&amp;pageid=83&amp;busquedaGeneral=".$_REQUEST["busquedaGeneral"]."&amp;zoom_page=".$page."&amp;zoom_per_page=".$per_page.$query_zoom_cats."&amp;zoom_and=".$and."&amp;zoom_sort=1\">". $STR_SORTBY_DATE . "</a>";
...
if ($num_pages > 1)
{
	...
	if ($page > 1)
		$OutputBuffers[$OUTPUT_PAGENUMBERS] .= "<a href=\"".$SelfURL.$LinkBackJoinChar."zoom_query=".$queryForURL.$metaParams."&amp;pageid=83&amp;busquedaGeneral=".$_REQUEST["busquedaGeneral"]."&amp;zoom_page=".($page-1)."&amp;zoom_per_page=".$per_page.$query_zoom_cats."&amp;zoom_and=".$and."&amp;zoom_sort=".$sort."\">&lt;&lt; " . $STR_RESULT_PAGES_PREVIOUS . "</a> ";
	for ($i = $start_range; $i <= $end_range; $i++)
	{
		if ($i == $page)
			$OutputBuffers[$OUTPUT_PAGENUMBERS] .= $page." ";
		else
			$OutputBuffers[$OUTPUT_PAGENUMBERS] .= "<a href=\"".$SelfURL.$LinkBackJoinChar."zoom_query=".$queryForURL.$metaParams."&amp;pageid=83&amp;busquedaGeneral=".$_REQUEST["busquedaGeneral"]."&amp;zoom_page=".($i)."&amp;zoom_per_page=".$per_page.$query_zoom_cats."&amp;zoom_and=".$and."&amp;zoom_sort=".$sort."\">".$i."</a> ";
	}
	if ($page != $num_pages)
		$OutputBuffers[$OUTPUT_PAGENUMBERS] .= "<a href=\"".$SelfURL.$LinkBackJoinChar."zoom_query=".$queryForURL.$metaParams."&amp;pageid=83&amp;busquedaGeneral=".$_REQUEST["busquedaGeneral"]."&amp;zoom_page=".($page+1)."&amp;zoom_per_page=".$per_page.$query_zoom_cats."&amp;zoom_and=".$and."&amp;zoom_sort=".$sort."\">" . $STR_RESULT_PAGES_NEXT . " &gt;&gt;</a> ";
