...
try {
	$sql =
		"INSERT INTO rrhh.hfs_formularioseguimiento (fs_id_formularioevaluacion, fs_positivonegativo, fs_fecha, fs_evento, fs_usualta, fs_fechaalta)
																				 VALUES (:idformularioevaluacion, :positivonegativo, SYSDATE, SUBSTR(:evento, 1, 2000), UPPER(:usualta), SYSDATE)";
