<?
$img = "/modules/mantenimiento/abm_arteria_noticias/images/imagen_plantilla_1.jpg";
		...
		<table cellpadding="0" cellspacing="0" width="100%" height="350">
			...
			<tr>
				...
				<td class="CuerpoArticulo" valign="top">
					<div id="imgder" style="margin-right:10px;"><img align="right" src="<?= $img?>" style="margin-bottom:8px; margin-left:8px;" /></div>
