...
<html>
	<head>
		...
		<script language="JavaScript" src="/modules/mantenimiento/abm_arteria_noticias/js/noticia.js"></script>
	</head>
...
?>
	<p>
		...
		<a href="/modules/mantenimiento/abm_arteria_noticias/guardar_imagen_noticia.php?tipoop=b&idnoticia=<?= $_REQUEST["idnoticia"]?>&id=<?= $row["IA_ID"]?>" onClick="return confirm('¿ Realmente desea quitar esta imagen ?')">
			<img alt="Quitar imagen" src="/modules/mantenimiento/abm_arteria_noticias/images/quitar_imagen.png" style="cursor:hand; vertical-align:top;" />
		</a>
	</p>
<?
}
