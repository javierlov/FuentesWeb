function achicarEncabezado() {
	with (document.getElementById('imgEncabezado')) {
		style.height = '';
		style.width = '';
	}
}
...
function agregarItem() {
	window.location.href = '/mantenimiento-menu-item/0';
}

function cambiaImagenEncabezado() {
	document.getElementById('imgEncabezado').src = '/images/encabezado_secciones/' + document.getElementById('encabezado').value + '.jpg';
}
...
function cancelarItem() {
	window.location.href = '/mantenimiento-menu';
}

function darBaja(id) {
	if (confirm('¿ Realmente desea dar de baja este item ?'))
		iframeProcesando.location.href = '/modules/mantenimiento/menu/dar_baja_item.php?id=' + id;
}

function editarItem(id) {
	window.location.href = '/mantenimiento-menu-item/' + id;
}
...
function guardar() {
	with (document) {
		...
		getElementById('formMenu').submit();
	}
}
