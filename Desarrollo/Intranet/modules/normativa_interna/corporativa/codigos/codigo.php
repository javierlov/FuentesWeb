	...
	<head>
		...
		<script language="JavaScript">
			...
			function aceptar() {
				with (document) {
					if (getElementById('check').checked)
						getElementById('iframeCodigo').src = '/modules/normativa_interna/corporativa/codigos/aceptar.php';
				}
			}
			...
			function chequear(valor) {
				with (document) {
					if (valor) {
						getElementById('btnAceptar').src = '/modules/normativa_interna/corporativa/codigos/images/aceptar.jpg';
						getElementById('btnAceptar').style.cursor = 'hand';
					}
					else {
						getElementById('btnAceptar').src = '/modules/normativa_interna/corporativa/codigos/images/aceptar_deshabilitado.jpg';
			...
			function recargar() {
				if ( (document.getElementById('notificado') != null) && (window.location.href != '/modules/normativa_interna/corporativa/codigos/codigo.php#notificado'))
					window.location.href = '/modules/normativa_interna/corporativa/codigos/codigo.php#notificado';
			}
...
<body>
	...
	<div align="center">
	<table cellpadding="2" cellspacing="0" width="770">
		<tr>
		...
		<tr>
			...
			<span style="font-family: Arial; color: white"><b><font size="2">1.</font></b><span style="font-style: normal; font-variant: normal; font-weight: 700; "><font size="2">&nbsp;</font></span><b><font size="2">ASPECTOS 
		...
		<tr>
			...
			<h2 style="text-indent: 0cm; line-height: normal; margin-top: 0; margin-bottom: 0">
			<span style="font-family: Arial; color: #00539B"><font size="2">1.1.</font><span style="font-style: normal; font-variant: normal; "><font size="2">
			</font>
			...
			<p class="MsoNormal" style="text-align: justify; line-height: normal; margin-bottom: 0; margin-top:0">
			<span style="font-size: 10.0pt; font-family: Arial">Los 
			...
			<span style="font-size: 10.0pt; font-family: Arial">&nbsp;</span></p>
			<p class="MsoNormal" style="text-align: justify; line-height: normal; margin-bottom: 0; margin-top:0">
			<span style="font-size: 10.0pt; font-family: Arial">Es 
			...
			<span style="font-style: normal; font-variant: normal; font-weight: 700; font-family: Arial; color:#0F6FC6">
			<font size="2">&gt; </font>
			...
			<p class="MsoNormal" style="text-align: justify; line-height: normal; margin-bottom: 0; margin-top:0">
			<span style="font-family: Arial; color: #00539B"><b>
		...
		<tr>
			...
			<table border="1" cellpadding="3" cellspacing="1" width="90%">
				<tr>
					...
					<font face="Arial" size="2" color="#FFFFFF">VALORES</font></b></td>
					<td width="335" align="center" bgcolor="#0F6FC6"><b>
					<font face="Arial" size="2" color="#FFFFFF">PRINCIPIOS 
					BÁSICOS</font></b></td>
				</tr>
				<tr>
					<td valign="top" width="334">
						<span style="font-style: normal; font-variant: normal; font-weight: 700; font-family: Arial; color:#0F6FC6">
			<font size="2">&gt; </font>
			</span><font face="Arial" size="2"><b>Integridad:</b> 
			...
			<span style="font-style: normal; font-variant: normal; font-weight: 700; font-family: Arial; color:#0F6FC6">
			<font size="2">&gt; </font>
			</span><font face="Arial" size="2"><b>Transparencia:</b> Difundir información adecuada y fiel de nuestra gestión, veraz y contrastable. Una comunicación clara, tanto interna como externamente.
						</font></p>
						<p>
			<span style="font-style: normal; font-variant: normal; font-weight: 700; font-family: Arial; color:#0F6FC6">
			<font size="2">&gt; </font>
			</span><font face="Arial" size="2"><b>Responsabilidad:</b> Asumir nuestras responsabilidades y actuar conforme a ellas, comprometiendo todas nuestras capacidades para cumplir con el objetivo propuesto.</font></p>
						<p>
			<span style="font-style: normal; font-variant: normal; font-weight: 700; font-family: Arial; color:#0F6FC6">
			<font size="2">&gt; </font>
			</span><font face="Arial" size="2"><b>Seguridad:</b> Brindar condiciones de trabajo apropiadas en cuanto a salubridad y seguridad. Exigir un alto nivel de seguridad en los procesos, instalaciones y servicios, prestando especial atención a la protección de los empleados, prestadores, proveedores, asegurados y entorno local, transmitiendo este principio de actuación a toda la organización.
			...
			<span style="font-style: normal; font-variant: normal; font-weight: 700; font-family: Arial; color:#0F6FC6">
			<font size="2">&gt; </font>
			</span><font face="Arial" size="2">Reconocer la dignidad de las personas y respetar su libertad y privacidad.</font></p>
						<p>
			<span style="font-style: normal; font-variant: normal; font-weight: 700; font-family: Arial; color:#0F6FC6">
			<font size="2">&gt; </font>
			</span><font face="Arial" size="2">Nadie debe ser discriminado por razones de sexo, estado civil, edad, religión, raza, capacidad física, preferencia política, preferencia sexual, clase social.</font></p>
						<p>
			<span style="font-style: normal; font-variant: normal; font-weight: 700; font-family: Arial; color:#0F6FC6">
			<font size="2">&gt; </font>
			</span><font face="Arial" size="2">Todo el personal que de alguna manera forme parte de la organización está obligado a cumplir con la legislación que rige o limita su área de responsabilidad. Asimismo,  con las normas y procedimientos de control interno que establezca la Compañía. En todo el personal se debe observar una conducta leal, respetuosa, diligente y honesta.</font></p>
						<p>
			<span style="font-style: normal; font-variant: normal; font-weight: 700; font-family: Arial; color:#0F6FC6">
			<font size="2">&gt; </font>
			</span><font face="Arial" size="2">Quienes tengan a su cargo personas que les reporten tienen la obligación moral de respetarlas y protegerlas en lo pertinente.</font></p>
						<p>
			<span style="font-style: normal; font-variant: normal; font-weight: 700; font-family: Arial; color:#0F6FC6">
			<font size="2">&gt; </font>
			</span><font face="Arial" size="2">Se prohíbe, condena y debe ser denunciado el acoso sexual por el daño moral que causa a quienes lo experimentan.</font></p>
						<p>
			<span style="font-style: normal; font-variant: normal; font-weight: 700; font-family: Arial; color:#0F6FC6">
			<font size="2">&gt; </font>
			</span><font face="Arial" size="2">Los directivos y empleados deben abstenerse de hacer comentarios, sea en medios familiares o sociales, sobre actividades que llevan a cabo dentro de la misma, que vayan en detrimento de ésta o de los demás directivos o empleados.</font></p>
						<p>
			<span style="font-style: normal; font-variant: normal; font-weight: 700; font-family: Arial; color:#0F6FC6">
			<font size="2">&gt; </font>
			</span><font face="Arial" size="2">Ningún directivo o empleado puede utilizar el nombre de Provincia ART, así como el resto de sus recursos, en actividades para su beneficio personal.</font></p>
					</td>
				</tr>
			</table>
			<p></div>
		...
		<tr>
			<td colspan="2">
			<h2 style="text-align: justify; text-indent: 0cm; line-height: normal; margin-top: 0; margin-bottom: 0">
			<span style="font-family: Arial; color: #00539B"><font size="2">1.3. ANTICORRUPCIÓN</font></span><font size="2" color="#00539B"><span style="font-family: Arial"> 
			...
			<span style="font-size: 10.0pt; font-family: Arial">&nbsp;</span></p>
			<p class="MsoNormal" style="text-align: justify; line-height: normal; margin-bottom: 0; margin-top:0">
			<span style="font-size: 10.0pt; font-family: Arial">Con 
			...
			<span style="font-size: 10.0pt; font-family: Arial">&nbsp;</span></p>
			<p class="MsoNormal" style="text-align: justify; line-height: normal; margin-bottom: 0; margin-top:0">
			<span style="font-size: 10.0pt; font-family: Arial">No 
			...
			<h2 style="text-align: justify; text-indent: 0cm; line-height: normal; margin-top: 0; margin-bottom: 0">
			<span style="font-family: Arial; color: #00539B"><font size="2">1.4.</font><span style="font-style: normal; font-variant: normal; "><font size="2">
			</font>
			...
			<span style="font-size: 10.0pt; font-family: Arial">&nbsp;</span></p>
			<p class="MsoNormal" style="text-align: justify; line-height: normal; margin-bottom: 0; margin-top:0">
			<span style="font-size: 10.0pt; font-family: Arial">Las 
		...
		<tr>
			<td bgcolor="#808080" colspan="2">
			<span style="font-family: Arial; color: white"><b><font size="2">2.</font></b><span style="font-style: normal; font-variant: normal; font-weight: 700; "><font size="2">&nbsp;</font></span><b><font size="2">ASPECTOS 
		...
		<tr>
			...
			<h2 style="text-indent: 0cm; line-height: normal; margin-top: 0; margin-bottom: 0">
			<span style="font-family: Arial; color: #00539B; ">
			<font size="2">2.1. REGLAS DE CONVIVENCIA INTERNA</font></span></h2>
			<p class="MsoNormal" style="text-align: justify; line-height: normal; margin-bottom: 0; margin-top:0">
			<span style="font-family: Arial; color: #00539B"><font size="2">&nbsp;</font></span></p>
			<h3 style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom:0">
			<span style="font-family: Arial; color: #00539B; font-weight:400">
			...
			<span style="font-size: 10.0pt; font-family: Arial; color: #0F6FC6; font-weight:700">
			*</span><span style="font-style: normal; font-variant: normal; font-weight: 700; font-family: Arial; color:#0F6FC6"><font size="2">&nbsp;</font></span><span style="font-size: 10.0pt; font-family: Arial">Mantener relaciones comerciales, en la condición de representante de 
			...
			<span style="font-family: Arial; font-weight:700">*</span></font><span style="font-style: normal; font-variant: normal; font-weight: 700; font-family: Arial; color:#0F6FC6"><font size="2">&nbsp;</font></span><span style="font-size: 10.0pt; font-family: Arial">Mantener relaciones comerciales particulares, de carácter habitual, 
			...
			<p class="MsoListParagraphCxSpMiddle" style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom: 0; margin-left:40px">
			<span style="font-size: 10.0pt; font-family: Arial; color: #0F6FC6; font-weight:700">
			*</span><span style="font-style: normal; font-variant: normal; font-weight: 700; font-family: Arial; color:#0F6FC6"><font size="2">&nbsp;</font></span><span style="font-size: 10.0pt; font-family: Arial">Usar el cargo, función o informaciones sobre negocios y asuntos de 
			...
			<p class="MsoListParagraphCxSpMiddle" style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom: 0; margin-left:40px">
			<font size="2" color="#0F6FC6">
			<span style="font-family: Arial; font-weight:700">*</span></font><span style="font-style: normal; font-variant: normal; font-weight: 700; font-family: Arial; color:#0F6FC6"><font size="2">&nbsp;</font></span><span style="font-size: 10.0pt; font-family: Arial">Contratar parientes proveedores/prestadores sin autorización del 
			...
			<p class="MsoListParagraphCxSpMiddle" style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom: 0; margin-left:40px">
			<span style="font-size: 10.0pt; font-family: Arial; color: #0F6FC6; font-weight:700">
			*</span><span style="font-style: normal; font-variant: normal; font-weight: 700; font-family: Arial; color:#0F6FC6"><font size="2">
			</font>
			</span>
			<span style="font-size: 10.0pt; font-family: Arial">
			...
			<p class="MsoListParagraphCxSpMiddle" style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom: 0; margin-left:40px">
			<font size="2" color="#0F6FC6">
			<span style="font-family: Arial; font-weight:700">*</span></font><span style="font-style: normal; font-variant: normal; font-weight: 700; font-family: Arial; color:#0F6FC6"><font size="2">&nbsp;</font></span><span style="font-size: 10.0pt; font-family: Arial">Usar para fines particulares o transferir a terceras partes las 
			...
			*</span><span style="font-style: normal; font-variant: normal; font-weight: 700; font-family: Arial; color:#0F6FC6"><font size="2">
			...
			<span style="font-size: 10.0pt; font-family: Arial">&nbsp;</span></p>
			<p class="MsoNormal" style="text-align: justify; line-height: normal; margin-bottom: 0; margin-top:0">
			<span style="font-size: 10.0pt; font-family: Arial">Son 
			...
			<h3 style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom:0">
			<span style="font-size: 10.0pt; font-family: Arial">&nbsp;</span></h3>
			<h3 style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom:0">
			<span style="font-family: Arial; color: #00539B; font-weight:400"><font size="2">Igualdad de 
			...
			<span style="font-size: 10.0pt; font-family: Arial">&nbsp;</span></h3>
			<h3 style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom:0">
			<span style="font-family: Arial; color: #00539B; font-weight:400"><font size="2">Salud, seguridad 
			...
			<span style="font-size: 10.0pt; font-family: Arial">&nbsp;</span></p>
			<h3 style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom:0">
			<span style="font-family: Arial; color: #00539B; font-weight:400"><font size="2">Responsabilidad 
			...
			<h3 style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom:0">
			<span style="font-family: Arial; color: #00539B; font-weight:400"><font size="2">Regalos, 
			...
			<span style="font-size: 10.0pt; font-family: Arial">&nbsp;</span></p>
			<h3 style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom:0">
			<span style="font-family: Arial; color: #00539B; font-weight:400"><font size="2">Uso y protección 
			...
			<h3 style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom:0">
			<span style="font-family: Arial"><font size="2">&nbsp;</font></span></h3>
			<h3 style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom:0">
			<span style="font-family: Arial; color: #00539B; font-weight:400"><font size="2">Calidad de la 
			información pública</font></span></h3>
			<h3 style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom:0">
			<span style="font-size: 10.0pt; font-family: Arial; color: windowtext; font-weight: normal">
			...
			<h3 style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom:0">
			<span style="font-family: Arial; color: #00539B; font-weight:400"><font size="2">Registros 
			...
			<span style="font-size: 10.0pt; font-family: Arial">&nbsp;</span></p>
			<h3 style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom:0">
			<span style="font-family: Arial; color: #00539B; font-weight:400"><font size="2">Protección de la 
			...
			<span style="font-size: 10.0pt; font-family: Arial">&nbsp;</span></h3>
			<h3 style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom:0">
			<span style="font-family: Arial; color: #00539B; font-weight:400"><font size="2">Contenido de la 
			...
			</span><font size="2">R</font></span><font size="2" color="#00539B"><span style="font-family: Arial">ELACIÓN 
			CON TERCEROS</span></font></h2>
			<h3 style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom:0">
			<span style="font-family: Arial"><font size="2">&nbsp;</font></span></h3>
			<h3 style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom:0">
			<span style="font-family: Arial; color: #00539B; font-weight:400"><font size="2">Afiliados</font></span></h3>
			<p class="MsoNormal" style="text-align: justify; line-height: normal; margin-bottom: 0; margin-top:0">
			<span style="font-size: 10.0pt; font-family: Arial">
			...
			<span style="font-style: normal; font-variant: normal; font-weight: 700; font-family: Arial; color:#0F6FC6">
			<font size="2">&gt; </font>
			</span><span style="font-size: 10.0pt; font-family: Arial">En 
			...
			<span style="font-size: 10.0pt; font-family: Arial">&nbsp;</span></h3>
			<h3 style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom:0">
			<span style="font-family: Arial; color: #00539B; font-weight:400"><font size="2">Prestadores / 
			...
			<span style="font-size: 10.0pt; font-family: Arial">&nbsp;</span></h3>
			<h3 style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom:0">
			<span style="font-family: Arial; color: #00539B; font-weight:400"><font size="2">Entes 
			...
			<span style="font-size: 10.0pt; font-family: Arial">&nbsp;</span></h3>
			<h3 style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom:0">
			<span style="font-family: Arial; color: #00539B; font-weight:400"><font size="2">Accionistas</font></span></h3>
			<h3 style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom:0">
			<span style="font-size: 10.0pt; font-family: Arial; color: windowtext; font-weight: normal">
			...
			<h3 style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom:0">
			<span style="font-family: Arial; color: #00539B; font-weight:400"><font size="2">Comunidad en 
			...
			<span style="font-size: 10.0pt; font-family: Arial">&nbsp;</span></h3>
			<h3 style="text-align: justify; line-height: normal; margin-top: 0; margin-bottom:0">
			<span style="font-family: Arial; color: #00539B; font-weight:400"><font size="2">Competencia</font></span></h3>
			<p class="MsoNormal" style="text-align: justify; line-height: normal; margin-bottom: 0; margin-top:0">
			<span style="font-size: 10.0pt; font-family: Arial">
...
?>
			<tr>
				<td width="418"><p align="right"><font face="Arial">&nbsp;<input checked disabled id="check" name="check" type="checkbox" value="ON"><font size="2"> Me doy por notificado</font></font>.</td>
				<td width="348"><img id="btnAceptar" name="btnAceptar" src="images/aceptar_deshabilitado.jpg"></td>
			</tr>
			<tr>
				<td align="center" colspan="2" id="notificado" style="background:#00539B; color:#FFFFFF; font-family:Arial; font-size:13px;">Usted se ha notificado el <?= $fechaAceptacion?></td>
			</tr>
<?
}
else {
?>
			<tr>
				<td width="418"><p align="right"><font face="Arial">&nbsp;<input id="check" name="check" type="checkbox" value="ON" onClick="chequear(this.checked)"><font size="2"> Me doy por notificado</font></font>.</td>
