...
$ver_combo = ValorSQL($sql, "", $params);
  ...
  if ($ver_combo == 'S') {
    $label = '<label class="labelTitulo">'.htmlentities("Aplicación", ENT_QUOTES, CHARSET).'<span class="small">'.htmlentities("Elija una aplicación del portal", ENT_QUOTES, CHARSET).'</span></label>';
