...
<head>
  ...
  <script type="text/javascript" src="Js/ticket.js?rnd=20140326" charset="iso-8859-1"></script>
...
<iframe id="iframeProcesando" name="iframeProcesando" src="about:blank" style="display:none;"></iframe>
  <div class="dock" id="dock">
    <div class="dock-container">
      <a class="dock-item" href="index.php?sistema=<?echo $sistema;?>&search=no"><img src="images/<?echo $sistema;?>/home.png" alt="Inicio" /><span>Inicio</span></a>
<!--
      <a class="dock-item" href="index.php?sistema=<?echo $sistema;?>&search=no"><img src="images/<?echo $sistema;?>/email.png" alt="Contáctenos" /><span>Contáctenos</span></a>
-->
      <a class="dock-item" href="index.php?sistema=<?echo $sistema;?>&newticket=yes"><img src="images/<?echo $sistema;?>/portfolio.png" alt="Realizar pedido" /><span>Realizar pedido</span></a>
      <a class="dock-item" href="index.php?sistema=<?echo $sistema;?>&search=yes&amp;all_tickets=no"><img src="images/<?echo $sistema;?>/calendar.png" alt="Pedidos actuales" /><span>Pedidos actuales</span></a>
      <a class="dock-item" href="index.php?sistema=<?echo $sistema;?>&search=yes&amp;all_tickets=yes"><img src="images/<?echo $sistema;?>/history.png" alt="Historial de pedidos" /><span>Historial de pedidos</span></a>
    </div>
  </div>
...
<div align="center" id="divProcesando" name="divProcesando" <?= ($showProcessMsg)?"show='ok'":""?> style="display:none">
  <img alt="Espere por favor..." src="images/<?echo $sistema;?>/cargando.gif" />
</div>
