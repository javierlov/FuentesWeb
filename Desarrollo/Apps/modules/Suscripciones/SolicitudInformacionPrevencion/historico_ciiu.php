...
<html>
	<head>
		<title>IntraWEB | Histórico por CIIU</title>
	...
	<body>
		<table class="Width600 GrisOscuro" cellpadding="0">
			<tr>
				...
				<td class="Title01" width="90%"><h5>Histórico por CIIU</h5></td>
...
$sql =
	"SELECT ¿cuit?, ¿ciiu?, ¿fecharespuesta?, ¿si_usurespuesta?, ¿porcentajeexpuestos?, ¿costoexamen?, ¿si_trabajadoresexpuestos?, ¿costototalperiodicos?, ¿costopromediovisita?,
		...
		WHERE sc_idactividad = (SELECT sc_idactividad
...
$grilla->addColumn(new Column("Costo Periódicos"));
